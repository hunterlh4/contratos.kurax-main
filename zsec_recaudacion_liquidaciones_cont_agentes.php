	...
	<div class="page-header wide">
		<div class="row">
			<div class="col-xs-12 text-center">
				<h1 class="page-title"><i class="icon icon-inline glyphicon glyphicon-briefcase"></i> Liquidaciones - Contabilidad Agentes
				</h1>
			</div>
		</div>
	</div>
...
<div class="container-fluid">
    <div class="row">
        <div class="container_filtros_recaudacion mt-4">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-2 mt-2">
                <label for="red_recaudacion">Red</label>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-2 mt-2">
                <label for="zona_recaudacion">Zonas Comerciales</label>
        ...
        <thead style="background-color:#fff !important; color:#fff !important; border-bottom:1px solid #ddd !important;">
            <tr>
                ...
                <th class="columna_zona_nombre_procesados_head_th">
                    <div class="contenedornombrecolumna" data-name="razon_social">RAZON SOCIAL</div>
                </th>
                <th class="columna_zona_nombre_procesados_head_th">
                    <div class="contenedornombrecolumna" data-name="ruc">RUC</div>
                </th>
                ...
                <th class="columnasnumeros_head_th">
                    <div class="contenedornombrecolumna" data-name="num_tickets_pendientes">N. TICKETS PENDIENTES</div>
                </th>
                <th class="columnasnumeros_head_th">
                    <div class="contenedornombrecolumna" data-name="efectivo_tickets_pendientes">EFECTIVO DE TICKETS PENDIENTES</div>
                </th>
                ...
                <th class="columnasnumeros_head_th">
                    <div class="contenedornombrecolumna" data-name="GGR">GGR</div>
                </th>
                ...
                <th class="columnasnumeros_head_th"><!-- IMPUESTO (12%) -->
                    <div class="contenedornombrecolumna" data-name="impuesto">IMPUESTO AL JUEGO (12%)</div>
                </th>
                <!-- <th class="columnasnumeros_head_th">
                    <div class="contenedornombrecolumna" data-name="impuesto_juego">IMPUESTO AL JUEGO</div>
                </th> -->
