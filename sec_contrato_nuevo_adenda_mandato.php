...
$permiso_ver = in_array("nuevo_adenda_mandato", $usuario_permisos[$menu_id]);
	...
	<div id="div_sec_contrato_nuevo">
		...
		<div class="row">
			<div class="col-xs-12 text-center">
				<h1 class="page-title titulosec_contrato"><i class="icon icon-inline glyphicon glyphicon-briefcase"></i> Nueva Solicitud - Adenda de Contrato de Mandato</h1>
			</div>
		</div>
							...
							<div class="row">
								<div class="col-xs-12 col-md-12 col-lg-12">
									<div class="form-group">
										...
										<select onchange="sec_con_nuevo_aden_mandat_obtener_contratos_interno_id()" class="form-control input_text select2" name="sec_con_nuevo_tienda" id="sec_con_nuevo_tienda">
										</select>
									</div>
								</div>
												...
												<div class="panel">
													...
													<div id="browsers-this-week" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="browsers-this-week-heading">
														<div class="panel-body">
															...
															<button type="button" class="btn btn-success btn-xs btn-block" id="btnRegistrarAdenda" onclick="sec_con_nuevo_aden_mandat_guardar_adenda();">
	...
	<div id="modal_adenda" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar Ventana</button>
					<button type="button" class="btn btn-success" id="btnModalRegistrarAdenda" onclick="sec_con_nuevo_aden_mandat_guardar_detalle_adenda('modalAgregar');">
						<i class="icon fa fa-plus"></i>
	...
	<div id="modalNuevoContraprestacion" class="modal fade" role="dialog" aria-labelledby="myLargeModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar Ventana</button>
					<button type="button" class="btn btn-success" onclick="sec_con_nuevo_aden_mandat_nuevo_contraprestacion()" id="btn_agregar_contraprestacion_ap">
						<i class="icon fa fa-plus"></i>
					...
					<div class="row">
						<form id="frmBuscarRemitente" autocomplete="off">
							...
							<div class="col-md-12 col-sm-12 col-xs-12" style="padding: 10px 15px 10px 15px;">
								<div class="form-group">
									...
									<div class="col-md-3 col-sm-3 col-xs-12" style="padding: 0px;">
										<button type="button" class="btn btn-success btn-sm btn-block" id="btnBuscarPropietario_ca" onclick="sec_con_nuevo_aden_mandat_buscar_propietario()">
							...
							<div id="divRegistrarNuevoPropietario_ca" class="col-md-12 col-sm-12 col-xs-12" style="display: none;">
								<div class="form-group">
									<button type="button" onclick="sec_con_nuevo_aden_mandat_propietario_modal()" class="btn btn-success btn-sm btn-block">
										<i class="icon fa fa-plus"></i>
	...
	<div id="modalNuevoPropietario_aa" class="modal fade" role="dialog" aria-labelledby="myLargeModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar Ventana</button>
					<button type="button" class="btn btn-success" onclick="sec_con_nuevo_aden_mandat_nuevo_propietario()">
						<i class="icon fa fa-plus"></i>
						Agregar propietario
					</button>
				</div>
	...
	<div id="modalNuevoBeneficiario" class="modal fade" role="dialog" aria-labelledby="myLargeModalLabel" style="overflow: inherit;">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar Ventana</button>
					<button type="button" class="btn btn-success" onclick="sec_con_nuevo_aden_mandat_guardar_beneficiario()">Agregar beneficiario</button>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button
						...
						onclick="sec_con_nuevo_aden_mandat_solicitud_guardar_incremento()">
						<i class="icon fa fa-plus"></i>
	...
	<div id="modalAgregarInflacion" class="modal fade" role="dialog" aria-labelledby="myLargeModalLabel">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button id="btn_modal_if_agregar_agregar" type="button" class="btn btn-success" onclick="sec_con_nuevo_aden_mandat_agregar_inflacion()">
						<i class="icon fa fa-plus"></i>
	...
	<div id="modalAgregarCuotaExtraordinaria" class="modal fade" role="dialog" aria-labelledby="myLargeModalLabel">
		<div class="modal-dialog modal-md" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button id="btn_modal_ce_agregar_agregar" type="button" class="btn btn-success" onclick="sec_con_nuevo_aden_mandat_agregar_cuota_extraordinaria()">
						<i class="icon fa fa-plus"></i>
	...
	<div id="modalNuevoResponsableIR" class="modal fade" role="dialog" aria-labelledby="myLargeModalLabel" style="overflow: inherit;">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar Ventana</button>
					<button type="button" class="btn btn-success" onclick="sec_con_nuevo_aden_mandat_guardar_responsable_ir()">Agregar Responsable IR</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="modalNuevoSuministro" class="modal fade" role="dialog" aria-labelledby="myLargeModalLabel" style="overflow: inherit;">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
						...
						<form id="frmNuevoSuministro" autocomplete="off">
							...
							<div class="col-xs-12 col-md-12 col-lg-12">
								<div class="form-group">
									...
									<select
										class="form-control select2"
										id="modal_suministro_compromiso_pago" onchange="sec_con_nuevo_aden_mandat_modal_change_tipo_compromiso()">
										<option value="0">- Seleccione -</option>
										<?php
										$sel_query = $mysqli->query("
									SELECT 
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar Ventana</button>
					<button type="button" class="btn btn-success" onclick="sec_con_nuevo_aden_mandat_agregar_suministro()">Agregar Suministro</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="modalNuevoArchivoAnexo" class="modal fade" role="dialog" aria-labelledby="myLargeModalLabel">
		<div class="modal-dialog modal-md" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar Ventana</button>
					<button type="button" class="btn btn-success" onclick="sec_con_nuevo_aden_anadir_archivo_mandato()">
						<i class="icon fa fa-plus"></i>
