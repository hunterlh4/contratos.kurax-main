	...
	<div class="page-header wide">
		<div class="row">
			<div class="col-xs-12 text-center">
				<h1 class="page-title titulosec_contrato"><i class="icon icon-inline glyphicon glyphicon-briefcase"></i> Contratos de Locaciones de Servicio</h1>
			</div>
		</div>
	</div>
		...
		<div class="row mt-4 mb-2">
			<form autocomplete="off">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-right" style="margin-top: 15px; margin-bottom: 15px; float: right;">
					...
					<span id="cont_locales_excel_locacion" class="float-left" style="padding: inherit;"></span>
		...
		<div class="row mt-3 mb-2">
			<div class="row form-horizontal">
				<?php if (in_array("xlsx", $usuario_permisos[$menu_id])) { ?>
					<div class="col-md-2" id="cont_locales_excel_locacion">
					</div>+
				<?php } ?>
