...
<div class="content container-fluid contratos_form_etapas">
	<div class="page-header wide">
		<div class="row">
			<div class="col-xs-12 text-center">
				<h1 class="page-title titulosec_contrato"><i class="icon icon-inline glyphicon glyphicon-briefcase"></i> Contratos de Arrendamientos</h1>
			</div>
		</div>
	</div>
	...
	<div class="page-header wide">
		<div class="row mt-4 mb-2">
			<form autocomplete="off">
				...
				<div class="form-group col-lg-2 col-md-3 col-sm-4 col-xs-12" style="height: 55px; display: none;">
					<label>Provincia (Inmueble):</label>
					<div class="form-group">
						<div class="input-group col-xs-12">
							<select class="form-control input_text select2 change-contrato-locales-firmado"
								data-live-search="true"
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-right" style="margin-top: 15px; margin-bottom: 15px; float: right;">
					...
					<span id="cont_locales_excel_arrendamiento" class="float-left" style="padding: inherit;"></span>
					<button type="button" class="btn btn-primary float-left" id="cont_locales_btn_buscar" onclick="buscarContratoPorParametros();">
		...
		<div class="row mt-3 mb-2">
			<div class="row form-horizontal">
				<?php if (in_array("xlsx", $usuario_permisos[$menu_id])) { ?>
					<div class="col-md-2" id="cont_locales_excel_arrendamiento">
					</div>+
				<?php } ?>
	...
	<div class="modal fade" id="configurarAlerta" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
					...
					<table id="tabla_datos_alerta" class="table table-striped table-bordered table-responsive">
						...
						<thead>
							<tr>
								...
								<th class="text-center">Ubicacion del inmueble</th>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-success" onclick="registrar_alerta();">
