...
SELECT 
 ...
 AND l.red_id in (9,1,16)
  AND ul.estado = 1
 AND u.estado = 1
 AND psop.estado = 1 AND psop.area_id = 21
 AND IF(l.red_id = 9, z.jop_id = psop.id, psop.cargo_id = 4)
 group by l.id,z.id
 ) Comercial
';
...
$request = [
	...
	"body" => $body,
	"cc" => [		
    "wally.camli@testtest.apuestatotal.com",
    ...
    "yolanda.nizama@testtest.apuestatotal.net",
    "cm.controlinterno@testtest.apuestatotal.com",
    "jenson.paico@testtest.apuestatotal.com",
    "jefferson.vicharra@testtest.apuestatotal.com",
    "omar.marin@testtest.apuestatotal.com",
    "danny.vassallo@testtest.igamingh.pe",
    "erlin.gutierrez@testtest.apuestatotal.com",
    "kathia.guillermo@testtest.apuestatotal.com"
	],
	"bcc" => [
		"bladimir.quispe@testtest.kurax.dev",
    "diego.ampuero@testtest.apuestatotal.com",
