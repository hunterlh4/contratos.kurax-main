...
if ($row["tipo_contrato_id"] == 14) {
	$continuar = true;
} else {
	echo 'En la presente página no se puede visualizar Contratos de Mandato';
}
			...
			<div class="col-xs-12">
				...
				<div class="col-md-8" style="margin-bottom: 10px; text-align: left;">
					<h1 class="page-title" style="margin-top: 10px;">
						<i class="icon icon-inline glyphicon glyphicon-briefcase"></i> <?php echo $etapa_id == 1 && $estado_aprobacion == 0 ? 'Solicitud de ' : ''; ?> Contrato de Mandato - Código: <?php echo $sigla_correlativo;
...
"
									...
									<div class="panel-heading" role="tab" id="headingDatosPropietarios">
										<h4 class="panel-title">
											<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordionContrato" href="#collapseDatosPropietarios" aria-expanded="true" aria-controls="collapseDatosPropietarios">
												DATOS DEL MANDANTE Y MANDATARIA
											</a>
										</h4>
									</div>
														...
														<table class="table table-bordered table-hover">
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td style="width: 75px;">
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud('Mandante','cont_persona','nombre','Nombre','varchar','<?php echo $sel["nombre"]; ?>','','<?php echo $sel["persona_id"]; ?>');">
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td>
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud('Mandante','cont_persona','tipo_docu_identidad_id','Tipo de Documento de Identidad','select_option','<?php echo $tipo_docu_identidad; ?>','obtener_tipo_docu_identidad','<?php echo $sel["persona_id"]; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
															...
															<?php if ($tipo_docu_identidad_id != "2") { ?>
																...
																<tr>
																	...
																	<?php if ($btn_editar_solicitud) { ?>
																		<td>
																			<a class="btn btn-success btn-xs"
																				onclick="sec_contrato_detalle_solicitudv2_editar_solicitud('Mandante','cont_persona','num_docu','Número de Documento de Identidad','varchar','<?php echo $num_docu_propietario; ?>','','<?php echo $sel["persona_id"]; ?>');">
																				<span class="fa fa-edit"></span> Editar
																			</a>
																		</td>
																	<?php } ?>
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td>
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud('Mandante','cont_persona','num_ruc','Número de RUC','varchar','<?php echo $num_ruc_propietario; ?>','','<?php echo $sel["persona_id"]; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td>
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud('Mandante','cont_persona','direccion','Domicilio del propietario','varchar','<?php echo $sel["direccion"]; ?>','','<?php echo $sel["persona_id"]; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td>
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud('Mandante','cont_persona','representante_legal','Representante Legal','varchar','<?php echo $sel["representante_legal"]; ?>','','<?php echo $sel["persona_id"]; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td>
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud('Mandante','cont_persona','num_partida_registral','N° de Partida Registral de la empresa','varchar','<?php echo $sel["num_partida_registral"]; ?>','','<?php echo $sel["persona_id"]; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
														...
														<table class="table table-bordered table-hover">
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td style="width: 75px;">
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud('Mandataria','tbl_razon_social','nombre','Nombre','varchar','<?php echo $sel["nombre"]; ?>','','<?php echo $sel["id"]; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td>
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud('Mandataria','tbl_razon_social','tipo_docu_identidad_id','Tipo de Documento de Identidad','select_option','<?php echo $tipo_docu_identidad; ?>','obtener_tipo_docu_identidad','<?php echo $sel["id"]; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
															...
															<?php if ($tipo_docu_identidad_id != "2") { ?>
																...
																<tr>
																	...
																	<?php if ($btn_editar_solicitud) { ?>
																		<td>
																			<a class="btn btn-success btn-xs"
																				onclick="sec_contrato_detalle_solicitudv2_editar_solicitud('Mandataria','tbl_razon_social','num_docu','Número de Documento de Identidad','varchar','<?php echo $num_docu; ?>','','<?php echo $sel["id"]; ?>');">
																				<span class="fa fa-edit"></span> Editar
																			</a>
																		</td>
																	<?php } ?>
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td>
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud('Mandataria','tbl_razon_social','num_ruc','Número de RUC','varchar','<?php echo $num_ruc; ?>','','<?php echo $sel["id"]; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td>
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud('Mandataria','tbl_razon_social','direccion','Domicilio del Arrendatario','varchar','<?php echo $sel["direccion"]; ?>','','<?php echo $sel["id"]; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td>
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud('Mandataria','tbl_razon_social','representante_legal','Representante Legal','varchar','<?php echo $sel["representante_legal"]; ?>','','<?php echo $sel["id"]; ?>');"> <span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
															</tr>
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td>
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud('Mandataria','tbl_razon_social','num_partida_registral','N° de Partida Registral de la empresa','varchar','<?php echo $sel["num_partida_registral"]; ?>','','<?php echo $sel["id"]; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
									...
									<div class="panel panel-default">
										...
										<div id="collapseDatosInmueble" class="panel-collapse-all panel-collapse collapse" role="tabpanel" aria-labelledby="headingDatosInmuebles">
											<div class="panel-body">
												...
												$mysqli->query("CREATE TEMPORARY TABLE temp_mandato AS 
												SELECT * FROM cont_mandato WHERE idcontrato = $contrato_id");
												...
												while ($adenda = $query_adendas->fetch_assoc()) {
													...
													$query_detalles = $mysqli->query("
														...
														WHERE adenda_id = " . $adenda_id . " AND status = 1 AND nombre_tabla = 'cont_mandato'
													");
												...
												//Para la tabla temporal de cont_contrato
												...
												$sel_query_mandato = $mysqli->query("
															...
															FROM temp_mandato man
															INNER JOIN temp_contrato cc on cc.contrato_id = man.idcontrato
															
															WHERE 
															man.idcontrato IN (" . $contrato_id . ") LIMIT 1
															");


												while ($row_mandato = $sel_query_mandato->fetch_assoc()) {
													$mandato_id = $row_mandato["id"];
													// $idcontrato = $sel["idcontrato"];
												...
												<div class="w-100">
													<div class="form-group">
														<table class="table table-bordered table-hover">
															<tr>
																<td style="width: 250px;"><b>La mandante es:</b></td>
																<td><?php echo $mandante_antecedente; ?></td>
																<?php if ($btn_editar_solicitud) { ?>
																	<td style="width: 75px;">
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud('Antecedentes','cont_mandato','mandante_antecedente','Nombre','varchar','<?php echo $mandante_antecedente; ?>','','<?php echo $mandato_id; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
												...
												<div class="w-100">
													<div class="form-group">
														<table class="table table-bordered table-hover">
															<tr>
																<td style="width: 250px;"><b>La mandataria se obliga a:</b></td>
																<td><?php echo $mandataria_objetivo; ?></td>
																<?php if ($btn_editar_solicitud) { ?>
																	<td style="width: 75px;">
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud('Objeto del Contrato','cont_mandato','mandataria_objetivo','Nombre','varchar','<?php echo $mandataria_objetivo; ?>','','<?php echo $mandato_id; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
												...
												<!-- 2.5 PANEL -->
												<!-- 2DO PANEL FIN -->
												<b>RETRIBUCION: FORMA Y OPORTUNIDAD DE PAGO</b>

												<div class="w-100">
													<div class="form-group">
														<table class="table table-bordered table-hover">
															<tr>
																<td style="width: 250px;"><b>De contraprestación por los servicios por la mandataria será el:</b></td>
																<td><?php echo $mandataria_retribucion; ?></td>
																<?php if ($btn_editar_solicitud) { ?>
																	<td style="width: 75px;">
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud('Retribución','cont_mandato','mandataria_retribucion','Contraprestación','varchar','<?php echo $mandataria_retribucion; ?>','','<?php echo $mandato_id; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
												...
												<div class="w-100">
													<div class="form-group">
														<table class="table table-bordered table-hover">
															...
															<tr>
																<td style="width: 250px;"><b>Plazo de duración</b></td>
																<td><?php echo $plazo_duracion; ?></td>
																<?php if ($btn_editar_solicitud) { ?>
																	<td style="width: 75px;">
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitud_editar_solicitud('Plazo del Contrato','cont_mandato','plazo_duracion','Duración','int','<?php echo $plazo_duracion; ?>','','<?= $mandato_id ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<!-- <td>
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitud_editar_solicitud('Plazo del Contrato','cont_mandato','fecha_inicio','Fecha de Inicio','date','<?php echo $fecha_inicio; ?>','','<?= $mandato_id ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td> -->
																<?php } ?>
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td>
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitud_editar_solicitud('Plazo del Contrato','cont_mandato','fecha_fin','Fecha de Fin','date','<?php echo $fecha_fin; ?>','','<?= $mandato_id ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
														...
														<table class="table table-bordered table-hover">
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td style="width: 75px;">
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud('Fecha de suscripción','cont_contrato','fecha_suscripcion_contrato','Fecha de suscripción del contrato','date','<?php echo $contrato_fecha_suscripcion; ?>','','');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
			...
			$query_detalle_contrato = "SELECT d.id, d.codigo, ce.condicion_economica_id, c.contrato_id, ce.plazo_id, CAST(man.fecha_inicio AS DATE) as fecha_inicio, CAST(man.fecha_fin AS DATE) as
			fecha_fin,
			...
			ce.renovacion_automatica 
					...
					LEFT JOIN cont_mandato as man ON man.idcontrato = c.contrato_id
					WHERE c.status = 1     
				...
				<div class="panel" id="divDetalleSolicitud">
					<div class="panel-body" style="padding: 5px 10px 5px 10px;">
						...
						AND a.status = 1;");
														...
														<div class="row">
															...
															<div class="col-md-12">
																<div class="form-group">
																	...
																	<button type="button" class="btn btn-success btn-xs btn-block" id="btn_guardar_adenda_firmada" onclick="sec_contrato_detalle_solicitud_mandato_guardar_adenda_firmada(<?= $adenda_id ?>)">
							...
							<?php if (($etapa_id == 1 and $estado_aprobacion == 1) or ($etapa_id == 5)) { ?>
								<div class="panel">
										...
										<div class="panel-body">
											...
											?>
													...
													<form id="form_contrato_firmado_<?= $contrato_detalle_id ?>" name="form_contrato_firmado_<?= $contrato_detalle_id ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
														...
														<div style="margin-right: 10px; margin-left: 5px;">
															<button type="button" class="btn btn-success btn-xs btn-block" id="btn_guardar_contrato_firmado_<?= $contrato_detalle_id ?>" onclick="sec_contrato_detalle_solicitud_verificar_documentos_mandato('<?= $contrato_detalle_id ?>')">
																<i class="icon fa fa-plus"></i>
												...
												<div class="panel-body">
													...
													<form id="form_contrato_proveedor_aprobar_gerencia" name="form_contrato_proveedor_firmado" method="POST" enctype="multipart/form-data" autocomplete="off">
														...
														<div class="col-xs-12 col-md-6 col-lg-6 item_filter">
															<button type="button" class="btn btn-success btn-xs btn-block col-md-6 cont_btn_guardar_aprobar_mandato" value="1" style="height: 30px;">
																<span id="demo-button-text">
																	<i class="glyphicon glyphicon-saved"></i>
																	Aceptar solicitud
																</span>
														...
														<div class="col-xs-12 col-md-6 col-lg-6 item_filter">
															<button type="button" class="btn btn-danger btn-xs btn-block cont_btn_guardar_aprobar_mandato" value="0" style="height: 30px;">
																<span id="demo-button-text">
																	<i class="glyphicon glyphicon-remove-sign"></i>
																	Rechazar solicitud
																</span>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Editar Solicitud de Mandato</h4>
				</div>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-success" onclick="sec_contrato_detalle_solicitudv2_editar_campo_solicitud_mandato('modal_editar_solicitud');">
			...
			<div class="modal-content">
				...
				<form>
					...
					<div class="modal-footer">
						...
						<button type="button" onclick="sec_contrato_detalle_solicitudv2_guardar_contrato_mandato()" class="btn btn-success">
