        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            ...
            <div class="panel">
                <div class="panel-heading">
                    <div class="panel-title">DETALLE DE LA ADENDA DE CONTRATO DE MANDATO</div>
                </div>
                            ...
                            <div class="col-xs-12 col-md-12 col-lg-7">
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body p-0">
                                                ...
                                                <div class="form-group">
                                                    <table class="table table-bordered table-hover">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 75px;">
                                                                <a class="btn btn-success btn-xs"
                                                                    onclick="sec_con_detalle_aden_mandato_solicitud_editar_campo_adenda('Descripción del Mutuante', 'cont_mutuodinero', 'mutuante_descripcion', 'Descripción', 'varchar', '<?php echo $mutuante_descripcion ?>','', '<?php echo $mutuodinero_id ?>');">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 75px;">
                                                                <a class="btn btn-success btn-xs"
                                                                    onclick="sec_con_detalle_aden_mandato_solicitud_editar_campo_adenda('Descripción del Mutuatario', 'cont_mutuodinero', 'mutuatario_descripcion', 'Descripción', 'varchar', '<?php echo $mutuatario_descripcion ?>','', '<?php echo $mutuodinero_id ?>');">
                                                                    <span class="fa fa-edit"></span> Editar
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 75px;">
                                                                <a class="btn btn-success btn-xs"
                                                                    onclick="sec_con_detalle_aden_mandato_solicitud_editar_campo_adenda('Plazo de Devolución', 'cont_mutuodinero', 'plazo_devolucion', 'Plazo', 'date', '<?php echo $plazo_devolucion ?>','','<?php echo $mutuodinero_id ?>');">
                                                                    <span class="fa fa-edit"></span> Editar
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td style="width: 75px;">
                                                                <a class="btn btn-success btn-xs"
                                                                    onclick="sec_con_detalle_aden_mandato_solicitud_editar_campo_adenda('Fecha de Suscripción', 'cont_contrato', 'fecha_suscripcion_contrato', 'Fecha', 'date', '<?php echo $contrato_fecha_suscripcion ?>','','');">
                                                                    <span class="fa fa-edit"></span> Editar
                                                                </a>
                                                            </td>
                                                        </tr>
                                                ...
                                                <div class="form-group">
                                                    <table class="table table-bordered table-hover">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 75px;">
                                                                <a class="btn btn-success btn-xs"
                                                                    onclick="sec_con_detalle_aden_mandato_solicitud_editar_campo_adenda('Importe Dinerario', 'cont_contraprestacion', 'moneda_id', 'Moneda', 'select_option', '<?php echo $moneda ?>', 'obtener_tipo_moneda', '<?php echo $moneda_id ?>');">
                                                                    <span class="fa fa-edit"></span> Editar
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td style="width: 75px;">
                                                                <a class="btn btn-success btn-xs"
                                                                    onclick="sec_con_detalle_aden_mandato_solicitud_editar_campo_adenda('Importe Dinerario', 'cont_contraprestacion', 'monto', 'Monto', 'decimal', '<?php echo $montostr ?>', '', '<?php echo $moneda_id ?>');">
                                                                    <span class="fa fa-edit"></span> Editar
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td style="width: 75px;">
                                                                <a class="btn btn-success btn-xs"
                                                                    onclick="sec_con_detalle_aden_mandato_solicitud_editar_campo_adenda('Importe Dinerario', 'cont_beneficiarios', 'banco_id', 'Banco', 'select_option', '<?php echo $banconombre ?>', 'obtener_banco', '<?php echo $contrato_id ?>');">
                                                                    <span class="fa fa-edit"></span> Editar
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td style="width: 75px;">
                                                                <a class="btn btn-success btn-xs"
                                                                    onclick="sec_con_detalle_aden_mandato_solicitud_editar_campo_adenda('Importe Dinerario', 'cont_beneficiarios', 'num_cuenta_bancaria', 'N° Cuenta Bancaria', 'int', '<?php echo $num_cuenta_bancaria ?>', '', '<?php echo $contrato_id ?>');">
                                                                    <span class="fa fa-edit"></span> Editar
                                                                </a>
                                                            </td>
                                                        </tr>
                                        ...
                                        <?php
                                        // Consulta para obtener los datos del mandato
                                                ...
                                                <div class="form-group">
                                                    <table class="table table-bordered table-hover">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 75px;">
                                                                <a class="btn btn-success btn-xs"
                                                                    onclick="sec_con_nuevo_aden_mandat_solicitud_editar_campo_adenda('Antecedentes', 'cont_mandato', 'mandante_antecedente', 'Nombre', 'varchar', '<?php echo $mandante_antecedente; ?>', '', '<?php echo $mandato_id; ?>');">
                                                                    <span class="fa fa-edit"></span> Editar
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td style="width: 75px;">
                                                                <a class="btn btn-success btn-xs"
                                                                    onclick="sec_con_nuevo_aden_mandat_solicitud_editar_campo_adenda('Objeto del Contrato', 'cont_mandato', 'mandataria_objetivo', 'Nombre', 'varchar', '<?php echo $mandataria_objetivo; ?>', '', '<?php echo $mandato_id; ?>');">
                                                                    <span class="fa fa-edit"></span> Editar
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 250px;"><b>De contraprestación por los
                                                                    servicios por la mandataria será el:</b></td>
                                                            <td><?php echo $mandataria_retribucion; ?></td>
                                                            <td style="width: 75px;">
                                                                <a class="btn btn-success btn-xs"
                                                                    onclick="sec_con_nuevo_aden_mandat_solicitud_editar_campo_adenda('Retribución', 'cont_mandato', 'mandataria_retribucion', 'Contraprestación', 'varchar', '<?php echo $mandataria_retribucion; ?>', '', '<?php echo $mandato_id; ?>');">
                                                                    <span class="fa fa-edit"></span> Editar
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td style="width: 75px;">
                                                                <a class="btn btn-success btn-xs"
                                                                    onclick="sec_con_nuevo_aden_mandat_solicitud_editar_campo_adenda('Plazo del Contrato', 'cont_mandato', 'plazo_duracion', 'Duración', 'int', '<?php echo $plazo_duracion; ?>', '', '<?php echo $mandato_id; ?>');">
                                                                    <span class="fa fa-edit"></span> Editar
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <!-- <td style="width: 75px;">
                                                                <a class="btn btn-success btn-xs"
                                                                    onclick="sec_con_nuevo_aden_mandat_solicitud_editar_campo_adenda('Plazo del Contrato', 'cont_mandato', 'fecha_inicio', 'Fecha de Inicio', 'date', '<?php echo $fecha_inicio; ?>', '', '<?php echo $mandato_id; ?>');">
                                                                    <span class="fa fa-edit"></span> Editar
                                                                </a>
                                                            </td> -->
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 250px;"><b>Fecha de Fin:</b></td>
                                                            <td><?php echo $fecha_fin; ?></td>
                                                            <td style="width: 75px;">
                                                                <a class="btn btn-success btn-xs"
                                                                    onclick="sec_con_nuevo_aden_mandat_solicitud_editar_campo_adenda('Plazo del Contrato', 'cont_mandato', 'fecha_fin', 'Fecha de Fin', 'date', '<?php echo $fecha_fin; ?>', '', '<?php echo $mandato_id; ?>');">
                                                                    <span class="fa fa-edit"></span> Editar
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <!-- <td style="width: 75px;">
                                                                <a class="btn btn-success btn-xs"
                                                                    onclick="sec_con_nuevo_aden_mandat_solicitud_editar_campo_adenda('Fecha de suscripción', 'cont_contrato', 'fecha_suscripcion_contrato', 'Fecha de suscripción del contrato', 'date', '<?php echo $contrato_fecha_suscripcion; ?>', '', '');">
                                                                    <span class="fa fa-edit"></span> Editar
                                                                </a>
                                                            </td> -->
                                                        </tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="btnModalRegistrarAdenda"
                    onclick="sec_con_detalle_aden_mandato_guardar_detalle_adenda('modalAgregar');">
                    <i class="icon fa fa-plus"></i>
