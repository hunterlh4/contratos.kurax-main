...
if($item_id){
	...
	if($sub_sec_id=="liquidaciones"){
					...
					<div class="col-xs-12" >
						<div class="col-xs-12 col-sm-12	col-md-6 col-lg-6">
							<div class="col-xs-12 col-sm-6 containerfechainicial">
								<p class="text-center iniciocustom">Inicio</p>
							...
							<div class="col-xs-12 col-sm-6">
								<p class="text-center fincustom">Fin</p>
		...
		<link rel="stylesheet" type="text/css" href="css/liquidaciones_modelos.css">
		<?php
		if($modelo==1){
			?>
			<div class="container-fluid">
		...
		if($modelo==2){
			?>	
			<div class="container-fluid">				
				<table id="tabla_sec_recaudacion" cellspacing="0" width="100%" class="display table-liquidaciones-modelo-2">
			        <thead>
			            <tr>
		...
		if($modelo==3){
			?>
			<div class="container-fluid">				
				<table id="tabla_sec_recaudacion" cellspacing="0" width="100%" class="display table-liquidaciones-modelo-3">
			        <thead>
			            <tr>
		...
		if($modelo==4){
			?>
			<div class="container-fluid">
				<table id="tabla_sec_recaudacion" cellspacing="0" width="100%"   class="display cell-border table-liquidaciones-modelo-4">
			        <thead>
			            <tr>
			                ...
			                <th class="columnasnumeros_head_th ">
			                    <div class="contenedornombrecolumna">T. DEPOSITADO</div>
			                </th>
			                <th class="columnasnumeros_head_th">
			                    <div class="contenedornombrecolumna">T. ANULADO /<br> RETIRADO</div>
			                </th>
			                <th class="columnasnumeros_head_th columna_apostado_modelo_cuatro_head_th">
			                    <div class="contenedornombrecolumna">T. APOSTADO</div>
			                </th>
			                <th class="columnasnumeros_head_th columna_ganado_modelo_cuatro_head_th">
			                    <div class="contenedornombrecolumna">T. GANADO</div>
			                </th>
			                <th class="columnasnumeros_head_th columna_pagado_modelo_cuatro_head_th">
			                    <div class="contenedornombrecolumna">T. PAGADO</div>
			                </th>
			                <th class="columnasnumeros_head_th columna_produccion_modelo_cuatro_head_th">
			                    <div class="contenedornombrecolumna">T. PRODUCCION</div>
			                </th>
			                <th class="columnasnumeros_head_th">
			                    <div class="contenedornombrecolumna">T. DEPOSITADO<br> WEB</div>
			                </th>
			                <th class="columnasnumeros_head_th">
			                    <div class="contenedornombrecolumna">T. RETITADO<br> WEB</div>
			                </th>
			                <th class="columnasnumeros_head_th">
			                    <div class="contenedornombrecolumna">T. CAJA<br> WEB</div>
			                </th>
			                <th class="columnasnumeros_head_th">
			                    <div class="contenedornombrecolumna">T. CLIENTE</div>
			                </th>
			                <th class="columnasnumeros_head_th">
			                    <div class="contenedornombrecolumna">T. FREEGAMES</div>
			                </th>
			                <th class="columnasnumeros_head_th">
			                ...
			                <th class="columnasnumeros_head_th">
			                    <div class="contenedornombrecolumna">T. PAGADOS <br>FISICOS</div>
			                </th>
			                <th class="columnasnumeros_head_th">
		...
		if ($modelo==5) {
			?>
			<div class="container-fluid">				
				<table id="tabla_sec_recaudacion" cellspacing="0" width="100%" class="display table-liquidaciones-modelo-5">
			        <thead>
			            <tr>
									...
									<div class="form-group form-group-inicio_fecha">
										...
										<div class="input-group col-xs-8">
											...
											<input 
												...
												id="input_text-inicio_fecha" 
												value="<?php echo date("d-m-Y", strtotime("-1 week"));?>" 
												readonly="readonly" 										 
												>
											<label class="input-group-addon glyphicon glyphicon-calendar" for="input_text-inicio_fecha"></label>
										</div>
			...
			<div class="modal-dialog modal-md">
				<div class="modal-content modal-rounded">
					...
					<div class="modal-body">
						...
						<input type="hidden" data-col="ref_bet_id" id="ref_bet_id" class="new_ticket_input">
						<input type="hidden" data-col="ref_servicio_id" id="ref_servicio_id" class="new_ticket_input">
						<div class="form-horizontal">
							...
							<?php
							foreach ($ticket_new_arr as $ti_k => $ti_v) {
								?>
								<div class="form-group">
									<label for="new_<?php echo $ti_k;?>" class="col-xs-4 control-label"><?php echo $ti_v;?>:</label>
									<div class="col-xs-8">
										<input type="text" class="form-control new_ticket_input" id="new_<?php echo $ti_k;?>" data-col="<?php echo $ti_k;?>" value="1">
									</div>
								</div>
								<?php
							}
							...
							<div class="form-group">
								...
								<div class="col-xs-8">
									<textarea class="form-control new_ticket_input" rows="3" data-col="descripcion">321</textarea>
								</div>
							</div>
						</div>
					</div>
			...
			<tbody>
				...
				foreach ($procesos as $pro_k => $pro_v) {
					...
					<tr class="">
						...
						<td><?php echo $pro_v["local_nombre"];?></td>
						<td><?php echo $pro_v["usuario"];?></td>						
						<td>
							<button class="btn btn-xs btn-rounded btn-default pago_manual_ver" data-id="<?php echo $pro_v["bet_id"];?>">Ver</button>								
						</td>
					</tr>
					<?php
				}
