...
if ($row["tipo_contrato_id"] == 15) {
	$continuar = true;
} else {
	echo 'En la presente página no se puede visualizar Contratos de Mutuo Dinero';
}
...
?>
	...
	<div id="div_sec_contrato_nuevo">
		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				<div class="col-md-8" style="margin-bottom: 10px; text-align: left;">
					<h1 class="page-title" style="margin-top: 10px;">
						<i class="icon icon-inline glyphicon glyphicon-briefcase"></i> <?php echo $etapa_id == 1 && $estado_aprobacion == 0 ? 'Solicitud de ' : ''; ?> Contrato de Mutuo de Dinero - Código: <?php echo $sigla_correlativo;
						...
						<form id="frmContratoDeArrendatario">
							...
							<div class="w-100" style="padding-right: 5px;">
								<div id="app" class="col-xs-12 col-md-12 col-lg-12" style="padding-right: 0px; padding-left: 10px; margin-bottom: 20px;">
									...
									if (($etapa_id == 1 && $estado_aprobacion == 0) && $area_id == $area_created_id && $cancelado_id != 1) { ?>
										...
										<div class="panel-body">
											<div class="w-100">
												...
												SELECT 
													...
													c.aprobador_id,
													CONCAT(IFNULL(p3.nombre, ''),' ', IFNULL(p3.apellido_paterno, ''),' ', IFNULL(p3.apellido_materno, '')) AS nombre_aprobador,
												...
												FROM
													...
													LEFT JOIN tbl_personal_apt p3 ON c.aprobador_id = p3.id
												WHERE 
													...
													while ($sel = $sel_query->fetch_assoc()) {
														...
														$contrato_fecha_suscripcion = $sel['contrato_fecha_suscripcion'];
														$ciudad = $sel['ciudad'];
													...
													?>
														<table class="table table-bordered table-hover">
															...
															<tr>
																<td style="width: 250px;"><b>Empresa (Mutuatario)</b></td>
																<td><?php echo $empresa_suscribe; ?></td>
																<?php if ($btn_editar_solicitud || ($etapa_id == 1 && $area_id == 33)) { ?>
																	<td style="width: 75px;">
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Generales','cont_contrato','empresa_suscribe_id','Empresa Arrendataria','select_option','<?php echo $empresa_suscribe; ?>','obtener_empresa_at');">
													...
													<table class="table table-bordered">
														...
														<!-- <tr>
															...
															<?php if ($btn_editar_solicitud) { ?>
																<td style="width: 75px;">
																	<a class="btn btn-success btn-xs"
																		onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Datos Generales','cont_contrato','cargo_aprobador_id','Cargo Aprobante','select_option','<?php echo $cargo_aprobante; ?>','obtener_cargos');">
																		<span class="fa fa-edit"></span> Editar
																	</a>
																</td>
															<?php } ?>
														...
														<table class="table table-bordered table-hover">
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td style="width: 75px;">
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Propietario','cont_persona','tipo_persona_id','Tipo de Persona','select_option','<?php echo $sel["tipo_persona"]; ?>','obtener_tipo_persona','<?php echo $sel["persona_id"]; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td>
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Propietario','cont_persona','nombre','Tipo Nombre Persona','varchar','<?php echo $sel["nombre"]; ?>','','<?php echo $sel["persona_id"]; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td>
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Propietario','cont_persona','tipo_docu_identidad_id','Tipo de Documento de Identidad','select_option','<?php echo $tipo_docu_identidad; ?>','obtener_tipo_docu_identidad','<?php echo $sel["persona_id"]; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
															...
															<?php if ($tipo_docu_identidad_id != "2") { ?>
																...
																<tr>
																	...
																	<?php if ($btn_editar_solicitud) { ?>
																		<td>
																			<a class="btn btn-success btn-xs"
																				onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Propietario','cont_persona','num_docu','Número de Documento de Identidad','varchar','<?php echo $num_docu_propietario; ?>','','<?php echo $sel["persona_id"]; ?>');">
																				<span class="fa fa-edit"></span> Editar
																			</a>
																		</td>
																	<?php } ?>
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td>
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Propietario','cont_persona','num_ruc','Número de RUC','varchar','<?php echo $num_ruc_propietario; ?>','','<?php echo $sel["persona_id"]; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td>
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Propietario','cont_persona','direccion','Domicilio del propietario','varchar','<?php echo $sel["direccion"]; ?>','','<?php echo $sel["persona_id"]; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td>
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Propietario','cont_persona','representante_legal','Representante Legal','varchar','<?php echo $sel["representante_legal"]; ?>','','<?php echo $sel["persona_id"]; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td>
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Propietario','cont_persona','num_partida_registral','N° de Partida Registral de la empresa','varchar','<?php echo $sel["num_partida_registral"]; ?>','','<?php echo $sel["persona_id"]; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td>
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Propietario','cont_persona','contacto_nombre','Persona de contacto','varchar','<?php echo $sel["contacto_nombre"]; ?>','','<?php echo $sel["persona_id"]; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td>
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Propietario','cont_persona','contacto_telefono','Teléfono de la persona de contacto','varchar','<?php echo $sel["contacto_telefono"]; ?>','','<?php echo $sel["persona_id"]; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td>
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Propietario','cont_persona','contacto_email','E-mail de la persona de contacto','varchar','<?php echo $sel["contacto_email"]; ?>','','<?php echo $sel["persona_id"]; ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
								...
								?>
									...
									<div class="panel panel-default">
										<div class="panel-heading" role="tab" id="headingDatosInmuebles<?= $num_contrato ?>">
											<h4 class="panel-title">
												<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordionContrato<?= $num_contrato ?>" href="#collapseDatosMutuo<?= $num_contrato ?>" aria-expanded="false" aria-controls="collapseDatosMutuo<?= $num_contrato ?>">
													Descripción de Actividades
												</a>
											</h4>
										</div>
										<div id="collapseDatosMutuo<?= $num_contrato ?>" class="panel-collapse-all panel-collapse collapse" role="tabpanel" aria-labelledby="headingDatosInmuebles<?= $num_contrato ?>">
											<div class="panel-body">

												<div class="w-100 mt-1">
													<div id="divTablaMutuo" class="form-group">
														<?php

														$mysqli->query("CREATE TEMPORARY TABLE temp_mutuodinero AS 
												SELECT * FROM cont_mutuodinero WHERE idcontrato = $contrato_id");
													...
													");
														...
														WHERE adenda_id = " . $adenda_id . " AND status = 1 AND nombre_tabla = 'cont_mutuodinero'
													");
													...
													md.idmutuodinero,
													md.mutuatario_descripcion,
													md.mutuante_descripcion,
													md.tasa_interes,
													md.plazo_devolucion 
													FROM temp_mutuodinero as md
													INNER JOIN cont_contrato cc on cc.contrato_id = md.idcontrato 
											WHERE cc.contrato_id = " . $contrato_id . ";");
														while ($sel = $sel_query->fetch_assoc()) {
															$idmutuodinero = $sel["idmutuodinero"];
															$mutuatario_descripcion = $sel["mutuatario_descripcion"];
															$mutuante_descripcion = $sel["mutuante_descripcion"];
															$tasa_interes = $sel["tasa_interes"];
															$plazo_devolucion = $sel["plazo_devolucion"];
														?>

															<table class="table table-bordered table-hover">
																<tr>
																	<td style="width: 250px;"><b>Mutuatario</b></td>
																	<td><?php echo $sel["mutuatario_descripcion"]; ?></td>
																	<?php if ($btn_editar_solicitud) { ?>
																		<td style="width: 75px;">
																			<a class="btn btn-success btn-xs"
																				onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Descripción de Actividades','cont_mutuodinero','mutuatario_descripcion','Mutuatario','textarea','<?php echo $sel["mutuatario_descripcion"]; ?>','','<?php echo $idmutuodinero; ?>');">
																				<span class="fa fa-edit"></span> Editar
																			</a>
																		</td>
																	<?php } ?>
																...
																<tr>
																	<td style="width: 250px;"><b>Mutuante</b></td>
																	<td><?php echo $sel["mutuante_descripcion"]; ?></td>
																	<?php if ($btn_editar_solicitud) { ?>
																		<td style="width: 75px;">
																			<a class="btn btn-success btn-xs"
																				onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Descripción de Actividades','cont_mutuodinero','mutuante_descripcion','Mutuante','textarea','<?php echo $sel["mutuante_descripcion"]; ?>','','<?php echo $idmutuodinero; ?>');">
																				<span class="fa fa-edit"></span> Editar
																			</a>
																		</td>
																	<?php } ?>
									...
									<div class="panel panel-default">
										<div class="panel-heading" role="tab" id="headingDatosInmuebles<?= $num_contrato ?>">
											<h4 class="panel-title">
												<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordionContrato<?= $num_contrato ?>" href="#collapseDatosImporteDinerario<?= $num_contrato ?>" aria-expanded="false" aria-controls="collapseDatosMutuo<?= $num_contrato ?>">
													Importe Dinerario
												</a>
											</h4>
										</div>
										<div id="collapseDatosImporteDinerario<?= $num_contrato ?>" class="panel-collapse-all panel-collapse collapse" role="tabpanel" aria-labelledby="headingDatosImporteDinerario<?= $num_contrato ?>">
											<div class="panel-body">

												<div class="w-100 mt-1">
													<div id="divTablaImporteDinerario" class="form-group">
														<?php
												...
												tm.nombre as moneda,
												tm.descripcion as descripcionmoneda,
												tm.simbolo as monedasimbolo,
												tm.sigla as monedasigla, 
												cb.nombre as beneficiarionombre,
												cb.num_cuenta_bancaria,
												cb.banco_id,
												tb.nombre as banconombre
												FROM cont_contrato cc
												INNER JOIN temp_contraprestacion cp on cp.contrato_id = cc.contrato_id
												INNER JOIN tbl_moneda tm on tm.id = cp.moneda_id
												INNER JOIN temp_beneficiarios cb ON cb.contrato_id = cc.contrato_id
												INNER JOIN tbl_bancos tb ON tb.id = cb.banco_id
											WHERE cc.contrato_id = " . $contrato_id . ";");
														while ($sel = $sel_query->fetch_assoc()) {
															$moneda_id = $sel["moneda_id"];
															$beneficiario_id = $sel["contrato_id"];
															$moneda = $sel["moneda"];
															$descripcionmoneda = $sel["descripcionmoneda"];
															$montostr = $sel["montostr"];
															$monedasimbolo = $sel["monedasimbolo"];
															$num_cuenta_bancaria = $sel["num_cuenta_bancaria"];
															$banconombre = $sel["banconombre"];
														?>

															<table class="table table-bordered table-hover">
																<tr>
																	<td style="width: 250px;"><b>Moneda</b></td>
																	<td><?php echo $sel["moneda"]; ?></td>
																	<?php if ($btn_editar_solicitud) { ?>
																		<td style="width: 75px;">
																			<a class="btn btn-success btn-xs"
																				onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Importe Dinerario','cont_contraprestacion','moneda_id','Moneda','select_option','<?php echo $sel["moneda"]; ?>','obtener_tipo_moneda','<?php echo $sel["moneda_id"]; ?>');">
																				<span class="fa fa-edit"></span> Editar
																			</a>
																		</td>
																	<?php } ?>
																...
																<tr>
																	...
																	<td><?php echo $sel["montostr"]; ?></td>
																	<?php if ($btn_editar_solicitud) { ?>
																		<td style="width: 75px;">
																			<a class="btn btn-success btn-xs"
																				onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Importe Dinerario','cont_contraprestacion','monto','Monto','decimal','<?php echo $sel["montostr"]; ?>','','<?php echo $sel["moneda_id"]; ?>');">
																				<span class="fa fa-edit"></span> Editar
																			</a>
																		</td>
																	<?php } ?>
																...
																<tr>
																	...
																	<td><?php echo $sel["banconombre"]; ?></td>
																	<?php if ($btn_editar_solicitud) { ?>
																		<td style="width: 75px;">
																			<a class="btn btn-success btn-xs"
																				onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Importe Dinerario','cont_beneficiarios','banco_id','Banco','select_option','<?php echo $sel["banconombre"]; ?>','obtener_banco','<?php echo $beneficiario_id; ?>');">
																				<span class="fa fa-edit"></span> Editar
																			</a>
																		</td>
																	<?php } ?>
																...
																<tr>
																	...
																	<td><?php echo $sel["num_cuenta_bancaria"]; ?></td>
																	<?php if ($btn_editar_solicitud) { ?>
																		<td style="width: 75px;">
																			<a class="btn btn-success btn-xs"
																				onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Importe Dinerario','cont_beneficiarios','num_cuenta_bancaria','N° Cuenta Bancaria','int','<?php echo $sel["num_cuenta_bancaria"]; ?>','','<?php echo $beneficiario_id; ?>');">
																				<span class="fa fa-edit"></span> Editar
																			</a>
																		</td>
																	<?php } ?>
									...
									<div class="panel panel-default">
										<div class="panel-heading" role="tab" id="headingBeneficiarios<?= $num_contrato ?>">
											<h4 class="panel-title">
												<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordionContrato<?= $num_contrato ?>" href="#collapseDatosPlazoDevolucion<?= $num_contrato ?>" aria-expanded="false" aria-controls="collapseDatosPlazoDevolucion<?= $num_contrato ?>">
													Tasa de Interés y Plazo para la Devolución
												</a>
											</h4>
										</div>
										<div id="collapseDatosPlazoDevolucion<?= $num_contrato ?>" class="panel-collapse-all panel-collapse collapse" role="tabpanel" aria-labelledby="headingDatosPlazoDevolucion<?= $num_contrato ?>">
											<div class="panel-body">

												<div class="w-100 mt-1">
													<div id="divTablaPlazoDevolucion" class="form-group">
														<?php
														$sel_query = $mysqli->query("SELECT 
												idmutuodinero,
												plazo_devolucion,
												tasa_interes,
												CONCAT(tasa_interes,' %') as tasa_interesstr,
												idcontrato
													FROM cont_mutuodinero b 
											WHERE b.idcontrato = " . $contrato_id . ";");
														while ($sel = $sel_query->fetch_assoc()) {
															$idmutuodinero = $sel["idmutuodinero"];
															$tasa_interes = $sel["tasa_interes"];
															$plazo_devolucion = $sel["plazo_devolucion"];
														?>
															...
															<table class="table table-bordered table-hover">
																<tr>
																	<td style="width: 250px;"><b>Tasa de interés</b></td>
																	<td><?php echo $sel["tasa_interesstr"]; ?></td>
																	<td style="width: 75px;">
																		<?php echo "No editable"; ?>
																	</td>
																</tr>
																<tr>
																	<td style="width: 250px;"><b>Plazo de devolución</b></td>
																	<td><?php echo $sel["plazo_devolucion"]; ?></td>
																	<?php if ($btn_editar_solicitud) { ?>
																		<td style="width: 75px;">
																			<a class="btn btn-success btn-xs"
																				onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Tasa de Interés y Plazo para la Devolución','cont_mutuodinero','plazo_devolucion','Plazo de Devolución','date','<?php echo $sel["plazo_devolucion"]; ?>','','<?php echo $idmutuodinero; ?>');">
																				<span class="fa fa-edit"></span> Editar
																			</a>
																		</td>
																	<?php } ?>
											...
											<div class="panel-body">
												<div class="w-100">
													<div class="form-group">
														<table class="table table-bordered table-hover">
															<tr>
																<td style="width: 250px;"><b>Lugar de suscripción del contrato</b></td>
																<td><?php echo $ciudad; ?></td>
																<?php if ($btn_editar_solicitud) { ?>
																	<td style="width: 75px;">
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Lugar de suscripción','cont_contrato','ciudad','Lugar de suscripción del contrato','varchar','<?php echo $ciudad; ?>','','<?= $contrato_id ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
															...
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td style="width: 75px;">
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Fecha de suscripción','cont_contrato','fecha_suscripcion_contrato','Fecha de suscripción del contrato','date','<?php echo $contrato_fecha_suscripcion; ?>','','<?= $contrato_id ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
														...
														<table class="table table-bordered table-hover">
															<tr>
																...
																<?php if ($btn_editar_solicitud) { ?>
																	<td style="width: 75px;">
																		<a class="btn btn-success btn-xs"
																			onclick="sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero('Observaciones','cont_contrato_detalle','observaciones','Observaciones','textarea','<?php echo replace_invalid_caracters_vista($sel_cont_det['observaciones']); ?>','','<?= $sel_cont_det['id'] ?>');">
																			<span class="fa fa-edit"></span> Editar
																		</a>
																	</td>
																<?php } ?>
			...
			$query_detalle_contrato = "SELECT d.id, d.codigo, ce.condicion_economica_id, ce.contrato_id, ce.plazo_id, NULL as fecha_inicio, CAST(mut.plazo_devolucion AS DATE) as
fecha_fin,
...
ce.renovacion_automatica 
		...
		LEFT JOIN cont_mutuodinero as mut ON mut.idcontrato = c.contrato_id
		WHERE c.status = 1   
									...
									AND ar.contrato_id = " . $contrato_id .
														...
														?>
															...
															<td colspan="3" class="text-center">
																No existen registros de adendas firmadas
															</td>
														...
														<div class="row">
															...
															<div class="col-md-12">
																<div class="form-group">
																	...
																	<button type="button" class="btn btn-success btn-xs btn-block" id="btn_guardar_adenda_firmada" onclick="sec_contrato_detalle_solicitud_mutuo_dinero_guardar_adenda_firmada(<?= $adenda_id ?>)">
											...
											WHERE
												...
												AND contrato_id = " . $contrato_id
													...
													<form id="form_contrato_firmado_<?= $contrato_detalle_id ?>" name="form_contrato_firmado_<?= $contrato_detalle_id ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
														...
														<div class="col-xs-12 col-md-6 col-lg-6" style="padding: 5px; display:none;">
															<div class="form-group">
																<label>
																	Plazo de devolución:
																</label>
														...
														<div style="margin-right: 10px; margin-left: 5px;">
															<button type="button" class="btn btn-success btn-xs btn-block" id="btn_guardar_contrato_firmado_<?= $contrato_detalle_id ?>" onclick="sec_contrato_detalle_solicitudv2_verificar_documentos_mutuodinero('<?= $contrato_detalle_id ?>')">
																<i class="icon fa fa-plus"></i>
												...
												<div class="panel-body">
													...
													<form id="form_contrato_proveedor_aprobar_gerencia" name="form_contrato_proveedor_firmado" method="POST" enctype="multipart/form-data" autocomplete="off">
														...
														<div class="col-xs-12 col-md-6 col-lg-6 item_filter">
															<button type="button" class="btn btn-success btn-xs btn-block col-md-6 cont_btn_guardar_aprobar_mutuodinero" value="1" style="height: 30px;">
																<span id="demo-button-text">
																	<i class="glyphicon glyphicon-saved"></i>
																	Aceptar solicitud
																</span>
														...
														<div class="col-xs-12 col-md-6 col-lg-6 item_filter">
															<button type="button" class="btn btn-danger btn-xs btn-block cont_btn_guardar_aprobar_mutuodinero" value="0" style="height: 30px;">
																<span id="demo-button-text">
																	<i class="glyphicon glyphicon-remove-sign"></i>
																	Rechazar solicitud
																</span>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Editar Solicitud de Mutuo Dinero</h4>
				</div>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-success" onclick="sec_contrato_detalle_solicitudv2_editar_campo_solicitud('modal_editar_solicitud');">
			...
			<div class="modal-content">
				...
				<form>
					...
					<div class="modal-footer">
						...
						<button type="button" onclick="sec_contrato_detalle_solicitudv2_guardar_contrato_firmado()" class="btn btn-success">
