...
function sec_contrato_detalle_solicitud_mutuodinero() {
  var midocu = "";
...
// function sec_contrato_detalle_solicitudv2_verificar_documentos_mutuodinero(
//   contrato_detalle_id
// ) {
//   var contrato_id = $("#contrato_id_temporal").val();
//   var nombre_tienda = $("#contrato_nombre_tienda_" + contrato_detalle_id)
//     .val()
//     .trim();
...
//   ).val();
//   var renovacion_automatica = $(
//     "#cont_detalle_renovacion_automatica_" + contrato_detalle_id
//   ).val();
...
//     $("#cont_detalle_renovacion_automatica_" + contrato_detalle_id).select2(
//       "open"
//     );
//     return false;
//   }
...
//         if (respuesta.result == "") {
//           sec_contrato_detalle_solicitudv2_guardar_contrato_firmado_mutuodinero(
//             contrato_detalle_id
//           );
//         } else {
...
function sec_contrato_detalle_solicitudv2_guardar_contrato_firmado_mutuodinero(
  contrato_detalle_id = 0
) {
  ...
  $.ajax({
    ...
    success: function (resp) {
      ...
      if (parseInt(respuesta.http_code) == 200) {
        ...
        var data_correo = {
          contrato_id: contrato_id,
          action: "contrato_mutuodinero/enviar_email_confirmacion_firmar_contrato_mutuodinero",
        };
...
$(".cont_btn_guardar_aprobar_mutuodinero").click(function () {
  var contrato_id = $("#contrato_id_temporal").val();
  var cont_detalle_aprobacion_param = $(this).val();
  var tipo_contrato_id = $("#tipo_contrato_id_temporal").val();
  var texto_mensaje_pregunta = "";
          ...
          success: function (resp) {
            ...
            if (respuesta.status) {
              var data_correo = {
                contrato_id: contrato_id,
                action:
                  "contrato_mutuodinero/enviar_email_confirmacion_aprobar_contrato_mutuodinero",
              };
...
function sec_contrato_detalle_solicitud_mutuo_dinero_guardar_adenda_firmada(id_adenda) {
  var contrato_id = $("#contrato_id_temporal").val();
  ...
  $.ajax({
    url: "sys/set_contrato_detalle_solicitud_mutuo_dinero.php",
    type: "POST",
    data: dataForm,
    cache: false,
    contentType: false,
...
function sec_contrato_detalle_solicitudv2_editar_solicitud_mutuodinero(
  nombre_menu_usuario,
  nombre_tabla,
  nombre_campo,
...
function sec_contrato_detalle_solicitudv2_editar_campo_solicitud(
  name_modal_close
) {
  var nombre_tabla = $("#editar_solicitud_nombre_tabla").val();
  var nombre_campo = $("#editar_solicitud_nombre_campo").val();
