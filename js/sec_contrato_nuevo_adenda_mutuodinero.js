...
function sec_contrato_nuevo_adenda_mutuodinero() {
	...
	sec_con_nuevo_aden_mutuodinero_obtener_opciones("obtener_tiendas","[name='sec_con_nuevo_tienda']");
	// sec_con_nuevo_aden_mutuodinero_obtener_opciones("obtener_abogados","[name='abogado_id']");
	// sec_con_nuevo_aden_mutuodinero_obtener_opciones("obtener_empresa_at","[name='sec_con_nuevo_empresa_grupo_at_2']");
	// sec_con_nuevo_aden_mutuodinero_obtener_opciones("obtener_bancos","[name='sec_con_nuevo_banco']");
	// sec_con_nuevo_aden_mutuodinero_obtener_opciones("obtener_periodo","[name='periodo']");
	// sec_con_nuevo_aden_mutuodinero_obtener_opciones("obtener_monedas","[name='modal_contr_ade_int_moneda_id']");
	// sec_con_nuevo_aden_mutuodinero_obtener_opciones("obtener_forma_pago","[name='modal_contr_ade_int_forma_pago']");
	// sec_con_nuevo_aden_mutuodinero_obtener_opciones("obtener_tipo_comprobante","[name='modal_contr_ade_int_tipo_comprobante']");
		...
		$("#modal_contr_ade_int_tipo_igv_id").change(function () {
			$("#modal_contr_ade_int_tipo_igv_id option:selected").each(function () {
				...
				if (modal_contr_ade_int_tipo_igv_id != 0) {
					sec_con_nuevo_aden_mutuodinero_calcular_subtotal_y_igv(modal_contr_ade_int_tipo_igv_id);
					setTimeout(function() {
...
function sec_con_nuevo_aden_mutuodinero_obtener_opciones(accion,select){
	$.ajax({
...
function sec_con_nuevo_aden_mutuodinero_obtener_contratos() {
...
function sec_con_nuevo_aden_mutuodinero_obtener_contratos_interno_id() {

	var contrato_id = $('#sec_con_nuevo_tienda').val();
	let data = {
		accion:'obtener_contrato_mutuodinero_por_id',
...
function sec_con_nuevo_aden_mutuodinero_solicitud_editar_campo_adenda(nombre_menu_usuario, nombre_tabla, nombre_campo, nombre_campo_usuario, tipo_valor, valor_actual, metodo_select, id_del_registro) {
	...
	if (tipo_valor == 'select_option') {
		...
		if (nombre_campo == 'ubigeo_id') {
			...
			$('#div_adenda_valor_select_option').hide();
			sec_con_nuevo_aden_mutuodinero_obtener_opciones(metodo_select,$("[name='adenda_inmueble_id_departamento']"));
			...
			sec_con_nuevo_aden_mutuodinero_obtener_opciones(metodo_select,$("[name='adenda_valor_select_option']"));
			setTimeout(function() {
...
function sec_con_nuevo_aden_mutuodinero_guardar_detalle_adenda(name_modal_close) {
	...
	$.ajax({
		url: "/sys/set_contrato_nuevo_adenda_mutuodinero.php",
		type: 'POST',
		data: data,
		beforeSend: function() {
			loading("true");
		...
		success: function(resp) { //  alert(datat)
			...
			if (parseInt(respuesta.http_code) == 200) {
				...
				sec_con_nuevo_aden_mutuodinero_asignar_detalle_a_la_adenda(respuesta.result, name_modal_close);
...
function sec_con_nuevo_aden_mutuodinero_asignar_detalle_a_la_adenda(id_adenda,modal){
	if (array_adendas_contrato.includes(id_adenda) === false){
		array_adendas_contrato.push(id_adenda)
	}

	sec_con_nuevo_aden_mutuodinero_actualizar_tabla_detalle_adenda();
	
}

function sec_con_nuevo_aden_mutuodinero_eliminar_detalle_adenda(id_adenda){
...
function sec_con_nuevo_aden_mutuodinero_actualizar_tabla_detalle_adenda(){
...
function sec_con_nuevo_aden_mutuodinero_agregar_representante(){
	$('#modalNuevoProveedor').modal({backdrop: 'static', keyboard: false});
	// sec_con_detalle_int_limpiarInputsRL();
}

function sec_con_nuevo_aden_mutuodinero_guardar_nuevo_representante_legal(){
	...
	$.ajax({
		...
		success: function(response, status) {
			...
			if (parseInt(respuesta.http_code) == 200) {
				...
				sec_con_nuevo_aden_mutuodinero_asignar_detalle_a_la_adenda(respuesta.result, 'modalNuevoProveedor');
			}
		},
...
function sec_con_nuevo_aden_mutuodinero_nuevo_contraprestacion_modal() {
...
function sec_con_nuevo_aden_mutuodinero_calcular_subtotal_y_igv(tipo)
{
...
function sec_con_nuevo_aden_mutuodinero_nuevo_contraprestacion() {
	var contrato_id = $('#id_registro_contrato_id').val();
	...
	$.ajax({
		...
		success: function(response) { //  alert(datat)
			...
			if (parseInt(respuesta.http_code) == 200) {
				$('#frm_adenda_nuevo_proveedor')[0].reset();
				sec_con_nuevo_aden_mutuodinero_asignar_detalle_a_la_adenda(respuesta.result, 'modalNuevoContraprestacion');
			}
...
function sec_con_nuevo_aden_mutuodinero_guardar_adenda() {
...
////// new
function sec_con_nuevo_aden_mutuodinero_buscar_propietario_modal(tipo,id_propiertario_old,id_persona_id) {
...
function  sec_con_nuevo_aden_mutuodinero_buscar_propietario() {
...
function sec_con_nuevo_aden_mutuodinero_agignar_propietario(id_persona){
	var contrato_id = $('#id_registro_contrato_id').val();
	...
	$.ajax({
		...
		success: function(response, status) {
			...
			auditoria_send({ "respuesta": "guardar_adenda_detalle_nuevos_registros", "data": respuesta });
			if (parseInt(respuesta.http_code) == 200) {			
				sec_con_nuevo_aden_mutuodinero_asignar_detalle_a_la_adenda(respuesta.result, 'modalBuscarPropietario_ca');
...
function sec_con_nuevo_aden_mutuodinero_reemplazar_propietario(id_persona){
...
function sec_con_nuevo_aden_mutuodinero_modal_eliminar_propietario(id_propietario){
...
function sec_con_nuevo_aden_mutuodinero_guardar_nuevo_representante_legalaaaaaa(){
	var contrato_id = $('#id_registro_contrato_id').val();
...
function sec_con_nuevo_aden_mutuodinero_propietario_modal() {
	...
	sec_con_nuevo_aden_mutuodinero_resetear_formulario_nuevo_propietario_agente();
...
function sec_con_nuevo_aden_mutuodinero_resetear_formulario_nuevo_propietario_agente() {
...
function sec_con_nuevo_aden_mutuodinero_nuevo_propietario() {
	...
	$.ajax({
		...
		success: function (resp) {
			...
			if (parseInt(respuesta.http_code) == 200) {
				$('#frm_adenda_nuevo_proveedor')[0].reset();
				sec_con_nuevo_aden_mutuodinero_asignar_detalle_a_la_adenda(respuesta.result, 'modalNuevoPropietario_aa');
			}
		},
		error: function () {},
	});
...
////BENEFICIARIOS
function sec_con_nuevo_aden_mutuodinero_modal_nuevo_beneficiario(tipo,id_beneficiario, contrato_detalle_id) {	
	...
	sec_con_nuevo_aden_mutuodinero_modal_resetear_formulario_nuevo_beneficiario("new");
...
function sec_con_nuevo_aden_mutuodinero_modal_resetear_formulario_nuevo_beneficiario(evento) {
...
function sec_con_nuevo_aden_mutuodinero_guardar_beneficiario() {
	var contrato_id = $('#id_registro_contrato_id').val();
	...
	$.ajax({
		...
		success: function (resp) {
			...
			if (parseInt(respuesta.http_code) == 200) {
				$('#frmNuevoBeneficiario')[0].reset();
				sec_con_nuevo_aden_mutuodinero_asignar_detalle_a_la_adenda(respuesta.result, 'modalNuevoBeneficiario');
				sec_con_nuevo_aden_mutuodinero_modal_resetear_formulario_nuevo_beneficiario();
			}
		},
		error: function () {},
	});
...
function sec_con_nuevo_aden_mutuodinero_modal_eliminar_beneficiario(id_beneficiario,contrato_detalle_id){
...
////BENEFICIARIOS
function sec_con_nuevo_aden_mutuodinero_modal_nuevo_responsable_ir(tipo,id_responsable_ir, contrato_detalle_id) {	
	...
	sec_con_nuevo_aden_mutuodinero_modal_resetear_formulario_nuevo_responsable_ir("new");
...
function sec_con_nuevo_aden_mutuodinero_modal_resetear_formulario_nuevo_responsable_ir(evento) {
...
function sec_con_nuevo_aden_mutuodinero_guardar_responsable_ir() {
	...
	$.ajax({
		...
		success: function (resp) {
			...
			if (parseInt(respuesta.http_code) == 200) {
				$('#frmNuevoBeneficiario')[0].reset();
				sec_con_nuevo_aden_mutuodinero_asignar_detalle_a_la_adenda(respuesta.result, 'modalNuevoResponsableIR');
				sec_con_nuevo_aden_mutuodinero_modal_resetear_formulario_nuevo_responsable_ir('new');
			}
		},
		error: function () {},
...
function sec_con_nuevo_aden_mutuodinero_modal_eliminar_responsable_ir(id_responsable_ir, contrato_detalle_id){
	...
	$.ajax({
		...
		success: function(resp) { //  alert(datat)
			...
			if (parseInt(respuesta.http_code) == 200) {
				// $('#frm_incremento')[0].reset();
				sec_con_nuevo_aden_mutuodinero_asignar_detalle_a_la_adenda(respuesta.result, '');
				// $('#modal_adenda').modal('hide');
				document.getElementById('divTablaAdendas').focus();
				return false;
			}
...
// INICIO INCREMENTOS
function sec_con_nuevo_aden_mutuodinero_modal_agregar_incrementos(contrato_detalle_id) {
	sec_con_nuevo_aden_mutuodinero_resetear_formulario_nuevo_incremento("new");
...
function sec_con_nuevo_aden_mutuodinero_resetear_formulario_nuevo_incremento(evento) {
...
function sec_con_nuevo_aden_mutuodinero_solicitud_guardar_incremento() {
	...
	$.ajax({
		...
		success: function (resp) {
			...
			if (parseInt(respuesta.http_code) == 200) {
				sec_con_nuevo_aden_mutuodinero_asignar_detalle_a_la_adenda(respuesta.result, 'modal_adenda_agregar_incrementos');	
...
// INICIO ENMIENDA
function sec_con_nuevo_aden_mutuodinero_solicitud_guardar_enmienda() {
}
// FIN ENMIENDA
...
function sec_con_nuevo_aden_mutuodinero_importar_contratos() {
	var data = {
...
// INICIO ENMIENDA
function sec_con_nuevo_aden_mutuodinero_modal_agregar_enmienda() {
...
/// INICIO INFLACION
function sec_con_nuevo_aden_mutuodinero_modal_agregar_inflacion(contrato_detalle_id) {
...
function sec_con_nuevo_aden_mutuodinero_agregar_inflacion() {
	...
	$.ajax({
		...
		success: function(resp) { //  alert(datat)
			...
			if (parseInt(respuesta.http_code) == 200) {
				sec_con_nuevo_aden_mutuodinero_asignar_detalle_a_la_adenda(respuesta.result, 'modalAgregarInflacion');
				document.getElementById('divTablaAdendas').focus();
				return false;
			}
...
function sec_con_nuevo_aden_mutuodinero_eliminar_inflacion(inflacion_id,contrato_detalle_id) {
...
function sec_con_nuevo_aden_mutuodinero_modal_agregar_cuota_extraordinaria(contrato_detalle_id) {
...
function sec_con_nuevo_aden_mutuodinero_agregar_cuota_extraordinaria() {
	...
	$.ajax({
		...
		success: function(resp) { //  alert(datat)
			...
			if (parseInt(respuesta.http_code) == 200) {
				sec_con_nuevo_aden_mutuodinero_asignar_detalle_a_la_adenda(respuesta.result, 'modalAgregarCuotaExtraordinaria');
				document.getElementById('divTablaAdendas').focus();
				return false;
			}
...
function sec_con_nuevo_aden_mutuodinero_eliminar_cuota_extraordinaria(cuota_extraordinaria_id, contrato_detalle_id) {
...
/// INICIO SUMINSITROS
function sec_con_nuevo_aden_mutuodinero_modal_agregar_suministro(tipo_servicio, inmueble_id, contrato_detalle_id) {
...
function sec_con_nuevo_aden_mutuodinero_modal_change_tipo_compromiso() {
...
function sec_con_nuevo_aden_mutuodinero_agregar_suministro() {
...
function sec_con_nuevo_aden_mutuodinero_eliminar_suministro(suministro_id,contrato_detalle_id) {
...
var array_nuevos_files_anexos = [];
function sec_con_nuevo_aden_anadir_archivo_mutuodinero() {
...
function sec_modal_adenda_mutuodinero_nuevo_archivo_anexo(tipo_contrato_id, contrato_detalle_id) {
