...
function sec_contrato_nuevo_adenda_arrendamiento() {
	...
	sec_con_nuevo_aden_arrend_obtener_opciones("obtener_tiendas","[name='sec_con_nuevo_tienda']");
	// sec_con_nuevo_aden_arrend_obtener_opciones("obtener_abogados","[name='abogado_id']");
	// sec_con_nuevo_aden_arrend_obtener_opciones("obtener_empresa_at","[name='sec_con_nuevo_empresa_grupo_at_2']");
	// sec_con_nuevo_aden_arrend_obtener_opciones("obtener_bancos","[name='sec_con_nuevo_banco']");
	// sec_con_nuevo_aden_arrend_obtener_opciones("obtener_periodo","[name='periodo']");
	// sec_con_nuevo_aden_arrend_obtener_opciones("obtener_monedas","[name='modal_contr_ade_int_moneda_id']");
	// sec_con_nuevo_aden_arrend_obtener_opciones("obtener_forma_pago","[name='modal_contr_ade_int_forma_pago']");
	// sec_con_nuevo_aden_arrend_obtener_opciones("obtener_tipo_comprobante","[name='modal_contr_ade_int_tipo_comprobante']");
		...
		$("#modal_contr_ade_int_tipo_igv_id").change(function () {
			$("#modal_contr_ade_int_tipo_igv_id option:selected").each(function () {
				...
				if (modal_contr_ade_int_tipo_igv_id != 0) {
					sec_con_nuevo_aden_arrend_calcular_subtotal_y_igv(modal_contr_ade_int_tipo_igv_id);
					setTimeout(function() {
...
function sec_con_nuevo_aden_arrend_obtener_opciones(accion,select){
	$.ajax({
...
function sec_con_nuevo_aden_arrend_obtener_contratos_interno_id() {
...
function sec_con_nuevo_aden_arrend_solicitud_editar_campo_adenda(nombre_menu_usuario, nombre_tabla, nombre_campo, nombre_campo_usuario, tipo_valor, valor_actual, metodo_select, id_del_registro) {
	...
	if (tipo_valor == 'select_option') {
		...
		if (nombre_campo == 'ubigeo_id') {
			...
			$('#div_adenda_valor_select_option').hide();
			sec_con_nuevo_aden_arrend_obtener_opciones(metodo_select,$("[name='adenda_inmueble_id_departamento']"));
			...
			sec_con_nuevo_aden_arrend_obtener_opciones(metodo_select,$("[name='adenda_valor_select_option']"));
			setTimeout(function() {
	...
	$.ajax({
		...
		success: function(resp) { //  alert(datat)
			...
			if (parseInt(respuesta.http_code) == 200) {
				...
				sec_con_nuevo_aden_arrend_asignar_detalle_a_la_adenda(respuesta.result, name_modal_close);
...
function sec_con_nuevo_aden_arrend_asignar_detalle_a_la_adenda(id_adenda,modal){
	...
	$.ajax({
		...
		success: function(response, status) {
			...
			if (parseInt(respuesta.http_code) == 200) {
				...
				sec_con_nuevo_aden_arrend_asignar_detalle_a_la_adenda(respuesta.result, 'modalNuevoProveedor');
			}
		},
...
function sec_con_nuevo_aden_arrend_nuevo_contraprestacion() {
	...
	$.ajax({
		...
		success: function(response) { //  alert(datat)
			...
			if (parseInt(respuesta.http_code) == 200) {
				$('#frm_adenda_nuevo_proveedor')[0].reset();
				sec_con_nuevo_aden_arrend_asignar_detalle_a_la_adenda(respuesta.result, 'modalNuevoContraprestacion');
			}
...
////// new
function sec_con_nuevo_aden_arrend_buscar_propietario_modal(tipo,id_propiertario_old,id_persona_id) {
...
function sec_con_nuevo_aden_arrend_agignar_propietario(id_persona){
	...
	$.ajax({
		...
		success: function(response, status) {
			...
			auditoria_send({ "respuesta": "guardar_adenda_detalle_nuevos_registros", "data": respuesta });
			if (parseInt(respuesta.http_code) == 200) {			
				sec_con_nuevo_aden_arrend_asignar_detalle_a_la_adenda(respuesta.result, 'modalBuscarPropietario_ca');
...
function sec_con_nuevo_aden_arrend_nuevo_propietario() {
	...
	$.ajax({
		...
		success: function (resp) {
			...
			if (parseInt(respuesta.http_code) == 200) {
				$('#frm_adenda_nuevo_proveedor')[0].reset();
				sec_con_nuevo_aden_arrend_asignar_detalle_a_la_adenda(respuesta.result, 'modalNuevoPropietario_aa');
			}
		},
		error: function () {},
	});
...
////BENEFICIARIOS
function sec_con_nuevo_aden_arrend_modal_nuevo_beneficiario(tipo,id_beneficiario, contrato_detalle_id) {	
...
function sec_con_nuevo_aden_arrend_modal_resetear_formulario_nuevo_beneficiario(evento) {
...
function sec_con_nuevo_aden_arrend_guardar_beneficiario() {
	...
	$.ajax({
		...
		success: function (resp) {
			...
			if (parseInt(respuesta.http_code) == 200) {
				$('#frmNuevoBeneficiario')[0].reset();
				sec_con_nuevo_aden_arrend_asignar_detalle_a_la_adenda(respuesta.result, 'modalNuevoBeneficiario');
...
function sec_con_nuevo_aden_arrend_modal_eliminar_beneficiario(id_beneficiario,contrato_detalle_id){
...
////BENEFICIARIOS
function sec_con_nuevo_aden_arrend_modal_nuevo_responsable_ir(tipo,id_responsable_ir, contrato_detalle_id) {	
	...
	sec_con_nuevo_aden_arrend_modal_resetear_formulario_nuevo_responsable_ir("new");
...
function sec_con_nuevo_aden_arrend_modal_resetear_formulario_nuevo_responsable_ir(evento) {
...
function sec_con_nuevo_aden_arrend_guardar_responsable_ir() {
	...
	$.ajax({
		...
		success: function (resp) {
			...
			if (parseInt(respuesta.http_code) == 200) {
				$('#frmNuevoBeneficiario')[0].reset();
				sec_con_nuevo_aden_arrend_asignar_detalle_a_la_adenda(respuesta.result, 'modalNuevoResponsableIR');
				sec_con_nuevo_aden_arrend_modal_resetear_formulario_nuevo_responsable_ir('new');
			}
		},
		error: function () {},
...
function sec_con_nuevo_aden_arrend_modal_eliminar_responsable_ir(id_responsable_ir, contrato_detalle_id){
	...
	$.ajax({
		...
		success: function(resp) { //  alert(datat)
			...
			if (parseInt(respuesta.http_code) == 200) {
				// $('#frm_incremento')[0].reset();
				sec_con_nuevo_aden_arrend_asignar_detalle_a_la_adenda(respuesta.result, '');
				// $('#modal_adenda').modal('hide');
				document.getElementById('divTablaAdendas').focus();
				return false;
			}
...
// INICIO INCREMENTOS
function sec_con_nuevo_aden_arrend_modal_agregar_incrementos(contrato_detalle_id) {
...
function sec_con_nuevo_aden_arrend_resetear_formulario_nuevo_incremento(evento) {
...
function sec_con_nuevo_aden_arrend_solicitud_guardar_incremento() {
	...
	$.ajax({
		...
		success: function (resp) {
			...
			if (parseInt(respuesta.http_code) == 200) {
				sec_con_nuevo_aden_arrend_asignar_detalle_a_la_adenda(respuesta.result, 'modal_adenda_agregar_incrementos');	
...
/// INICIO INFLACION
function sec_con_nuevo_aden_arrend_modal_agregar_inflacion(contrato_detalle_id) {
...
function sec_con_nuevo_aden_arrend_agregar_inflacion() {
	...
	$.ajax({
		...
		success: function(resp) { //  alert(datat)
			...
			if (parseInt(respuesta.http_code) == 200) {
				sec_con_nuevo_aden_arrend_asignar_detalle_a_la_adenda(respuesta.result, 'modalAgregarInflacion');
				document.getElementById('divTablaAdendas').focus();
				return false;
			}
...
function sec_con_nuevo_aden_arrend_eliminar_inflacion(inflacion_id,contrato_detalle_id) {
...
function sec_con_nuevo_aden_arrend_modal_agregar_cuota_extraordinaria(contrato_detalle_id) {
...
function sec_con_nuevo_aden_arrend_agregar_cuota_extraordinaria() {
	...
	$.ajax({
		...
		success: function(resp) { //  alert(datat)
			...
			if (parseInt(respuesta.http_code) == 200) {
				sec_con_nuevo_aden_arrend_asignar_detalle_a_la_adenda(respuesta.result, 'modalAgregarCuotaExtraordinaria');
				document.getElementById('divTablaAdendas').focus();
				return false;
			}
...
function sec_con_nuevo_aden_arrend_eliminar_cuota_extraordinaria(cuota_extraordinaria_id, contrato_detalle_id) {
...
/// INICIO SUMINSITROS
function sec_con_nuevo_aden_arrend_modal_agregar_suministro(tipo_servicio, inmueble_id, contrato_detalle_id) {
...
function sec_con_nuevo_aden_arrend_eliminar_suministro(suministro_id,contrato_detalle_id) {
