$(document).ready(function () {
    if ($('#sec_soporte_alerta_deposit_web').length == 0) {
    } else {

        fncRenderizarDataTableListadoLocalesAlertaDepositWeb();
...
function fncRenderizarDataTableListadoLocalesAlertaDepositWeb() {

    var table = $('#tbl_alerta_deposit_web_negra_switch').DataTable();
    table.clear();
    table.destroy();
    var table = $('#tbl_alerta_deposit_web_negra_switch').DataTable({
        'destroy': true,
        ...
        "ajax": {
            ...
            "data": { accion: 'sec_soporte_alerta_deposit_web_listar_locales' }
    ...
    $('#tbl_alerta_deposit_web_negra_switch tbody').off('click');

    $('#tbl_alerta_deposit_web_negra_switch tbody').on('click', '.btn', function () {
        ...
        if (data == undefined) {
            ...
            rowData = $('#tbl_alerta_deposit_web_negra_switch').DataTable().row(selected_row).data();
        } else {
            rowData = data;
        }
