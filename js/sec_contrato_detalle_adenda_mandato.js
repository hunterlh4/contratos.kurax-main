...
function sec_contrato_detalle_adenda_mandato() {
...
function sec_con_detalle_aden_arrend_obtener_opciones(accion,select){
	$.ajax({
	   url: "/sys/get_contrato_nuevo_adenda_mandato.php",
	   type: 'POST',
...
function sec_con_detalle_aden_mandato_solicitud_editar_campo_adenda(nombre_menu_usuario, nombre_tabla, nombre_campo, nombre_campo_usuario, tipo_valor, valor_actual, metodo_select, id_del_registro) {
...
function sec_con_detalle_aden_mandato_guardar_detalle_adenda(name_modal_close) {
	...
	if (nombre_campo === "fecha_fin") {
        var fechaOriginal = new Date(valor_actual.split('-').reverse().join('-'));
	...
	$.ajax({
		url: "/sys/set_contrato_detalle_adenda_mandato.php",
		type: 'POST',
		data: data,
		beforeSend: function() {
			loading("true");
...
// 		var data = {
// 			"accion": "obtener_adendas_detalle_mandato",
// 			"adendas": array_adendas_contrato,
// 		}

// 		auditoria_send({ "proceso": "obtener_adendas_detalle_mandato", "data": data });
// 		$.ajax({
// 			url: "/sys/set_contrato_detalle_adenda_mandato.php",
// 			type: 'POST',
// 			data: data,
...
function sec_con_detalle_aden_arrend_actualizar_tabla_detalle_adenda() {
    ...
    if (array_adendas_contrato.length > 0) {
        ...
        // Auditoría (opcional)
        auditoria_send({
            "proceso": "obtener_adendas_detalle_mandato",
            "data": data
        });
