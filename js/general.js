...
$(function($) {
    ...
    //var $ls={};
        //parse_str(parse_url(window.location.href,"query"),$ls);
       // $.each($ls, function(index, val) {
       //     localStorage.setItem(index,val);
       // });

    localStorage.setItem("sec_id",$("#sec_id").val());
    localStorage.setItem("sub_sec_id",$("#sub_sec_id").val());
    localStorage.setItem("item_id",$("#item_id").val());
   ...
   // console.log(localStorage);
    ...
    if(is_mobile){
        ...
        if(localStorage.menu_sidebar_expanded){
            $body.addClass('expanded');
            $("#menu_"+localStorage.getItem("sec_id")).addClass("open");
        }else{
            $body.removeClass('expanded');
            $('.sub-toggle').removeClass('sub-open');
    ...
    $('.sidebar-collapse').click(function(e) {
        ...
        if($body.hasClass('expanded')){
            localStorage.setItem("menu_sidebar_expanded", "true");
            $('#contSearch').show();
        }else{
            localStorage.removeItem("menu_sidebar_expanded");
            $('#contSearch').hide();
        }
    });
