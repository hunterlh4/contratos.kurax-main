<div class="panel">
    <div class="panel-heading text-center">
        <div class="panel-title">Alertas de correos por Cargo</div>
    </div>
    <div class="panel-body">
            ...
            <form method="POST" id="Frm_RegistroCorreoMetodo" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="row">
                   ...
                   <div class="col-md-4">
                        <div class="form-group">
                            <label>Áreas</label>
                            <select id="cont_mant_corr_area_id" name="cont_mant_corr_area_id" class="form-control select2"></select>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label></label>
                            <button type="button" onclick="sec_contrato_mant_met_frm_reset_cargo()" class="btn form-control btn-danger">Cancelar</button>
                        </div>
                    </div>
                </div>
            </form>
        ...
        ?>
        <hr>
        <input type="hidden" id="edicion_metodo_cargo" value="<?=$permiso_edicion?>">
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table display responsive" style="width:100%"" id="tbl_correo_cargo">
                    <thead>
                        <tr>
