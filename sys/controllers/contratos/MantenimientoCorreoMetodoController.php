...
class MantenimientoCorreoMetodoController
{
        ...
        try {
            ...
            if (($model->get_usuario_id()) > 0) {
                ...
                foreach ($registro['result'] as $be) {
                    ...
                    $acciones .= '<button type=button" class="btn btn-rounded btn-info btn-xs" title="Ver" onclick="sec_contrato_mant_met_modal_correos('.$be['id'].')">
                    <i class="fa fa-eye"></i>												
                </button>';
                    if ($edicion_metodo_correo == 1) { // funciona con permisos
                        $acciones .= '<button type=button" class="btn btn-rounded btn-primary btn-xs" title="Editar" onclick="sec_contrato_mant_met_obtener_por_id('.$be['id'].')">
                                        <i class="fa fa-pencil"></i>												
                                    </button>';
                        $acciones .= '<button type=button" class="btn btn-rounded btn-danger btn-xs" title="Eliminar" onclick="sec_contrato_mant_met_eliminar_por_id('.$be['id'].')">
