...
class ContratoMutuoDineroController
{
    public function registrar()
    {
        ...
        try {
            ...
            $model_contrato =  new ContratoMutuoDinero();
            if (($model_contrato->get_usuario_id()) > 0) {
                ...
                $contratos_ciudad = json_decode($request['contratos'], true);
                ...
                $data_cotrato['ciudad'] = $contratos_ciudad[0]['ciudad'];
                $data_cotrato['fecha_suscripcion_contrato'] = $contratos_ciudad[0]['fecha_subscripcion'];
                ...
                $contratos[0]['beneficiario'] = $propietarios[0];
                ...
                $model_contraprestacion = new ContratoMutuoDinero();

                $data_contraprestacion = array(
                    'contrato_id' => $contrato_id,
                    'monto' => $contratos[0]['monto'],
                    'moneda_id' => $contratos[0]['tipo_moneda_id'],
                ...
                $model_locacion = new ContratoMutuoDinero();

                $data_mutuodinero = array(
                    'idcontrato' => $contrato_id,
                    'mutuante_descripcion' => $contratos[0]['mutuante_descripcion'],
                    'mutuatario_descripcion' => $contratos[0]['mutuatario_descripcion'],
                    'tasa_interes' => 0,
                    'plazo_devolucion' => $contratos[0]['fecha_plazo_limite'],
                    'user_created_id' =>  $model_contrato->get_usuario_id(),
                    'created_at' => $created_at,
                );
                $insert_mutuodinero = $model_locacion->registrar_mutuodinero($data_mutuodinero);

                if ($insert_mutuodinero['status'] == 404) {
                    return $insert_mutuodinero;
                }
                ...
                $this->enviar_email_confirmacion_solicitud_contrato_mutuodinero($contrato_id, false);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            //NOTIFICAR A LOS ABOGADOS CARGO 34 SOBRE LA CREACION DE SOLICITUD DE MUTUO DINERO //////////////////////////////
            function enviar_email_confirmacion_solicitud_contrato_mutuodinero($contrato_id, $reenviar) {
                $host = $_SERVER["HTTP_HOST"];
                $model_contrato = new ContratoMutuoDinero();
                $data_contrato2 = $model_contrato->obtener_solicitud_contrato_mutuodinero_detallado($contrato_id);
                ...
                <head>
                    ...
                    <title>Detalle de Solicitud de Contrato de Mutuo Dinero</title>
                    <style>
                ...
                <body>
                    <div class="title">Solicitud de Contrato: Mutuo Dinero</div>';
                ...
                $body .= '<table>
                            ...
                            <tr>
                                ...
                                <td>MD' . $data_contrato2['datos_generales']['codigo_correlativo'] . '</td>
                            </tr>
                            <tr>
                ...
                // Datos del Mutuo Dinero
                foreach ($data_contrato2['data_mutuodinero'] as $mutuo) {
                    $body .= '<table>
                                <tr>
                                    <th colspan="2">Datos del Mutuo Dinero</th>
                                </tr>
                                <tr>
                                    <td><strong>Mutuante</strong></td>
                                    <td>' . $mutuo['mutuante_descripcion'] . '</td>
                                </tr>
                                <tr>
                                    <td><strong>Mutuatario</strong></td>
                                    <td>' . $mutuo['mutuatario_descripcion'] . '</td>
                                </tr>
                                <tr>
                                    <td><strong>Tasa de Interés</strong></td>
                                    <td>' . $mutuo['tasa_interes'] . '%</td>
                                </tr>
                                <tr>
                                    <td><strong>Plazo de Devolución</strong></td>
                                    <td>' . $mutuo['plazo_devolucion'] . '</td>
                                </tr>
                              </table>';
                }
                ...
                $body .= '<div style="width: 700px; text-align: center; font-family: arial;">
                            <a href="http://contratos.kurax.test:90/?sec_id=contrato&sub_sec_id=detalle_solicitud_mutuo_dinero&id=' . $contrato_id . '" style="background-color: #4CAF50; border: none; color: white; padding: 5px 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px;">
                                <b>Ver Solicitud</b>
                            </a>
                          </div>
                          </body>
                ...
                // Título del correo
                if ($reenviar) {
                    $titulo = "Gestión - Sistema Contratos - Reenviar Confirmación de Solicitud de Contrato de Mutuo Dinero: Código - MD" . $data_contrato2['datos_generales']['codigo_correlativo'];
                } else {
                    $titulo = "Gestión - Sistema Contratos - Confirmación de Solicitud de Contrato de Mutuo Dinero: Código - MD" . $data_contrato2['datos_generales']['codigo_correlativo'];
                }
            ...
            //NOTIFICAR AL ABOGADO SELECCIONADO EN LA APROBACION DE LA SOLICITUD DE MUTUO DINERO ///////////////////////////////////
            function enviar_email_confirmacion_aprobar_contrato_mutuodinero($contrato_id, $reenviar = false) {
                ...
                <body>
                    <div class="title">Aprobación de Solicitud de Contrato de Mutuo Dinero</div>
                    <table>
                        <tr>
                            <th colspan="2">Datos Generales del Contrato</th>
                        </tr>
                    ...
                    <table>
                        <tr>
                            <th colspan="2">Detalles del Mutuo Dinero</th>
                        </tr>
                        <tr>
                            <td><strong>Mutuante</strong></td>
                            <td>' . $data_contrato2['data_mutuodinero'][0]['mutuante_descripcion'] . '</td>
                        </tr>
                        <tr>
                            <td><strong>Mutuatario</strong></td>
                            <td>' . $data_contrato2['data_mutuodinero'][0]['mutuatario_descripcion'] . '</td>
                        </tr>
                        <tr>
                            <td><strong>Tasa de Interés</strong></td>
                            <td>' . $data_contrato2['data_mutuodinero'][0]['tasa_interes'] . '%</td>
                        </tr>
                        <tr>
                            <td><strong>Plazo de Devolución</strong></td>
                            <td>' . $data_contrato2['data_mutuodinero'][0]['plazo_devolucion'] . '</td>
                        </tr>
                    </table>
                    <table>
                        <tr>
                    ...
                    <div style="width: 700px; text-align: center; font-family: arial;">
                        <a href="http://contratos.kurax.test:90/?sec_id=contrato&sub_sec_id=detalle_solicitud_mutuodinero&id=' . $contrato_id . '" style="background-color: #4CAF50; border: none; color: white; padding: 5px 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px;">
                            <b>Ver Solicitud</b>
                        </a>
                    </div>
                </body>
                ...
                // Título para solicitud de mutuo dinero
                if ($reenviar) {
                    $titulo = "Gestión - Sistema Contratos - Reenviar Confirmación de Contrato de Mutuo Dinero: Código - MD" . $codigo_correlativo;
                } else {
                    $titulo = "Gestión - Sistema Contratos - Confirmación de Contrato de Mutuo Dinero: Código - MD" . $codigo_correlativo;
                }
            ...
            //NOTIFICAR AL ABOGADO SELECCIONADO EN LA FIRMA DE UN CONTRATO DE MUTUO DINERO ///////////////////////////////////
            function enviar_email_confirmacion_firmar_contrato_mutuodinero($contrato_id, $reenviar = false) {
                $contrato_id = $_POST['contrato_id'];
                $host = $_SERVER["HTTP_HOST"];
                $model_contrato = new ContratoMutuoDinero();
                $data_contrato2 = $model_contrato->obtener_solicitud_contrato_mutuodinero_detallado($contrato_id);
                ...
                <head>
                    <meta charset="UTF-8">
                    <meta name="viewport" content="width=device-width, initial-scale=1.0">
                    <title>Confirmación de Firma de Contrato de Mutuo Dinero</title>
                    <style>
                        body { font-family: Arial, sans-serif; width: 700px; }
                        table { width: 100%; border-collapse: collapse; margin-bottom: 20px; width: 700px; }
                        th, td { border: 1px solid #ddd; padding: 8px; text-align: left; }
                ...
                <body>
                    <div class="title">Confirmación de Contrato de Mutuo Dinero Firmado</div>
                    <table>
                        <tr>
                ...
                if ($reenviar) {
                    $titulo = "Gestión - Sistema Contratos - Reenviar Confirmación de Contrato de Mutuo Dinero Firmado: Código - MD" . $codigo_correlativo;
                } else {
                    $titulo = "Gestión - Sistema Contratos - Confirmación de Contrato de Mutuo Dinero Firmado: Código - MD" . $codigo_correlativo;
                }
        ...
        try {
            ...
            if (($model_contrato->get_usuario_id()) > 0) {
                ...
                for ($l = 0; $l < count($contratos); $l++) {
                    ...
                    $data_beneficiario['contrato_id'] = $contrato_id;
                    $data_beneficiario['contrato_detalle_id'] = $contrato_detalle_id;
                    $data_beneficiario['tipo_persona_id'] = $beneficiario['tipo_persona_id'];
                    ...
                    $data_beneficiario['forma_pago_id'] = 2;  //Depósito en Cuenta Bancaria
                    $data_beneficiario['tipo_monto_id'] = 3;  //Totalidad
                    $data_beneficiario['banco_id'] = $contrato['banco_val']['id'];
                    $data_beneficiario['num_cuenta_bancaria'] = $contrato['num_cuenta_bancaria'];
                    ...
                    //                     $model_locacion = new ContratoMutuoDinero();
                    // //var_dump($contrato); die();
                    //                     $data_locacion = array(
                    //                         'idcontratodetalle' => $contrato_detalle_id,
                    //                         'idcontrato' => $contrato_id,
                    //                         'nombreservicio' => $contrato['locador_nombre_servicio'],
                    //                         'fechainicio' => $contrato['fecha_inicio'],
                    //                         'fechafin' => $contrato['fecha_fin'],
                    //                         'locador_descripcion' => $contrato['locador_descripción'],
                    //                         'locatario_descripcion' => $contrato['locatario_descripcion'],
                    //                         'locador_funciones' => $contrato['locador_funciones']
                    //                     );

                    //                     $insert_locacion = $model_locacion->registrar_locacion($data_locacion);
    ...
    function send_email_solicitud_contrato_arrendamiento_detallado($contrato_id, $enviar_respuesta, $reenvio)
    {
        ...
        if ($estado_aprobacion) { // aprobado
            ...
            echo "Correos a enviar:\n";
            print_r($lista_correos);
            $cc = $lista_correos['cc'];
            $bcc = $lista_correos['bcc'];
            $titulo = "Gestion - Sistema Contratos - Nueva Solicitud de Arrendamiento: Código - " . $sigla_correlativo . $codigo_correlativo;
            if ($reenvio) {
