...
class ContratoLocacionServicioController
{
    public function registrar()
    {
        ...
        try {
            ...
            $model_contrato =  new ContratoLocacionServicio();
            if (($model_contrato->get_usuario_id()) > 0) {
                ...
                $data_cotrato['fecha_suscripcion'] = $contratos_fecha_suscripcion[0]['fecha_subscripcion'];
                ...
                $model_contraprestacion = new ContratoLocacionServicio();
                ...
                $this->enviar_email_confirmacion_solicitud_contrato_locacion($contrato_id, false);
            ...
            function enviar_email_confirmacion_solicitud_contrato_locacion($contrato_id, $reenviar)
            {
                $host = $_SERVER["HTTP_HOST"];
                $model_contrato = new ContratoLocacionServicio();
                $data_contrato2 = $model_contrato->obtener_solicitud_contrato_locacion_detallado($contrato_id);
                ...
                <body>
                    <div class="title">Solicitud de Contrato: Locación de Servicios</div>';
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>' . $data_contrato2['datos_generales']['codigo_correlativo'] . '</td>
                    </tr>
                    <tr>
                ...
                foreach ($data_contrato2['data_locacion'] as $locacion) {
                    $body .= '
                    <table>
                        <tr>
                            <th colspan="2">Datos de la Locación</th>
                        </tr>
                        <tr>
                            <td><strong>Nombre del Servicio</strong></td>
                            <td>' . $locacion['nombreservicio'] . '</td>
                        </tr>
                        <tr>
                            <td><strong>Fecha de Inicio</strong></td>
                            <td>' . $locacion['fechainicio'] . '</td>
                        </tr>
                        <tr>
                            <td><strong>Fecha de Fin</strong></td>
                            <td>' . $locacion['fechafin'] . '</td>
                        </tr>
                        <tr>
                            <td><strong>Descripción del Locador</strong></td>
                            <td>' . $locacion['locador_descripcion'] . '</td>
                        </tr>
                        <tr>
                            <td><strong>Descripción del Locatario</strong></td>
                            <td>' . $locacion['locatario_descripcion'] . '</td>
                        </tr>
                        <tr>
                            <td><strong>Funciones del Locador</strong></td>
                            <td>' . $locacion['locador_funciones'] . '</td>
                        </tr>
                    </table>';
                }
                ...
                $body .= '
                    ...
                    <div style="width: 700px; text-align: center; font-family: arial;">
                        <a href="http://contratos.kurax.test:90/?sec_id=contrato&sub_sec_id=detalle_solicitud_locacion_servicio&id=' . $contrato_id . '" style="background-color: #4CAF50; border: none; color: white; padding: 5px 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px;">
                            <b>Ver Solicitud</b>
                        </a>
                    </div>
                </body>
                ...
                if ($reenviar) {
                    $titulo = "Gestion - Sistema Contratos - Reenviar Confirmación de Solicitud de Contrato Locación de Servicios: Código - " . "LS" . $data_contrato2['datos_generales']['codigo_correlativo'];
                } else {
                    $titulo = "Gestion - Sistema Contratos - Confirmación de Solicitud de Contrato Locación de Servicios: Código - " . "LS" . $data_contrato2['datos_generales']['codigo_correlativo'];
                }
            ...
            function enviar_email_confirmacion_aprobar_contrato_locacion($contrato_id, $reenviar=false) {
                ...
                <head>
                    <meta charset="UTF-8">
                    <meta name="viewport" content="width=device-width, initial-scale=1.0">
                    <title>Detalle de Solicitud de Contrato de Locación</title>
                    <style>
                        body { font-family: Arial, sans-serif; width:700px; }
                        table { width: 100%; border-collapse: collapse; margin-bottom: 20px; width:700px; }
                        th, td { border: 1px solid #ddd; padding: 8px; text-align: left; }
                ...
                <body>
                    <div class="title">Aprobación de Solicitud de Contrato de Locación</div>
                    ...
                    <table>
                        <tr>
                            <th colspan="2">Detalles de la Locación</th>
                        </tr>
                        <tr>
                            <td><strong>Fecha de Inicio</strong></td>
                            <td>' . $data_contrato2['data_locacion'][0]['fechainicio'] . '</td>
                        </tr>
                        <tr>
                            <td><strong>Fecha de Fin</strong></td>
                            <td>' . $data_contrato2['data_locacion'][0]['fechafin'] . '</td>
                        </tr>
                    </table>
                    ...
                    <div style="width: 700px; text-align: center; font-family: arial;">
                        <a href="http://contratos.kurax.test:90/?sec_id=contrato&sub_sec_id=detalle_solicitud_locacion_servicio&id=' . $contrato_id . '" 
                ...
                // Título para solicitud de locación
                if ($reenviar) {
                    $titulo = "Gestion - Sistema Contratos - Reenviar Confirmación de Contrato de Locación: Código - LS" . $codigo_correlativo;
                } else {
                    $titulo = "Gestion - Sistema Contratos - Confirmación de Contrato de Locación: Código - LS" . $codigo_correlativo;
                }
            ...
            ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            //NOTIFICAR AL ABOGADO SELECCIONADO EN LA FIRMA DE UN CONTRATO DE LOCACION ///////////////////////////////////
            function enviar_email_confirmacion_firmar_contrato_locacion($contrato_id, $reenviar=false) {
                $contrato_id = $_POST['contrato_id'];
                $host = $_SERVER["HTTP_HOST"];
                $model_contrato = new ContratoLocacionServicio();
                $data_contrato2 = $model_contrato->obtener_solicitud_contrato_locacion_detallado($contrato_id);
                ...
                <head>
                    <meta charset="UTF-8">
                    <meta name="viewport" content="width=device-width, initial-scale=1.0">
                    <title>Confirmación de Firma de Contrato de Locación</title>
                    <style>
                        body { font-family: Arial, sans-serif; width:700px; }
                        table { width: 100%; border-collapse: collapse; margin-bottom: 20px; width:700px; }
                        th, td { border: 1px solid #ddd; padding: 8px; text-align: left; }
                ...
                <body>
                    <div class="title">Confirmación de Contrato de Locación Firmado</div>
                ...
                $titulo = "Gestion - Sistema Contratos - Contrato de Locación Firmado: Código - LS" . $codigo_correlativo;
        ...
        try {
            ...
            if (($model_contrato->get_usuario_id()) > 0) {
                ...
                for ($l = 0; $l < count($contratos); $l++) {
                    ...
                    $model_locacion = new ContratoLocacionServicio();
                    $data_locacion = array(
