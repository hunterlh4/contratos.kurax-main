	...
	if(isset($_POST["id_del_registro"]) && !empty($_POST["id_del_registro"])) {
		...
		if($_POST["nombre_tabla"] == "cont_contrato_detalle"){
			...
			if($row_count > 0){
                ...
                if ($_POST["nombre_tabla"] == "cont_mandato") {
                    $contrato_detalle_id = $row['idcontratodetalle']; // Para cont_mandato
                } else {
...
if (isset($_POST["accion"]) && $_POST["accion"]==="obtener_adendas_detalle_mandato") {
