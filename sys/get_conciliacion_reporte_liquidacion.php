...
if (isset($_POST["accion"]) && $_POST["accion"] === "conci_reporte_liquidacion_Datatable") {
    ...
    $column_titles = [
        "comision_calimaco" => "Comisión CALIMACO",
        "comision_proveedor" => "Comisión PROVEEDOR",
        "comision_calimaco-comision_proveedor" => "Diferencia de Comisión",
        "liquidated_count" => "Conteo Liquidados Completados",
        "non_matching_count" => "Conteo Liquidados Incompletos",
    ];
...
if (isset($_POST["accion"]) && $_POST["accion"] === "conci_reporte_liquidacion_proveedor_listar") {
    try {
