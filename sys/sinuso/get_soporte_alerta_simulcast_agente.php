...
if (isset($_POST["accion"]) && $_POST["accion"] === "sec_soporte_alerta_simulcast_agente_listar_locales") {
    try {
        $error = '';
        ...
        FROM
            ...
            WHERE lc.config_id = 'alerta_simulcast_agente' and l.red_id in (5)
		";
...
if (isset($_POST["accion"]) && $_POST["accion"] === "sec_soporte_simulcast_agente_cambiar_estado") {
    try {
        $error = '';
        $mensaje = '';
        $id = (int)$_POST['id'];
