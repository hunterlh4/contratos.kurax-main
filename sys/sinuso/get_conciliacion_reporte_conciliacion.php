...
if (isset($_POST["accion"]) && $_POST["accion"] === "conci_reporte_conciliacion_Datatable") {
    ...
    $column_titles = [
        "monto_calimaco" => "Monto CALIMACO",
        "monto_proveedor" => "Monto PROVEEDOR",
        "monto_calimaco - monto_proveedor" => "Monto Diferencia",
        "ROUND(calimaco_count)" => "Conteo CALIMACO",
        "proveedor_count" => "Conteo PROVEEDOR",
        "calimaco_count - proveedor_count" => "Conteo Diferencia",
        "reconciled_count" => "Conteo CONCILIADOS",
        "calimaco_count-reconciled_count" => "Conteo no CONCILIADOS",
        "duplicate_count" => "Conteo DUPLICADOS",
    ];
...
if (isset($_POST["accion"]) && $_POST["accion"] === "conci_reporte_conciliacion_proveedor_listar") {
    try {
