...
if (isset($_POST["accion"]) && $_POST["accion"] === "conci_mant_correo_guardar") {
    ...
    if ((int)$usuario_id > 0) {
        ...
        if ((int)$id > 0) {
            ...
            $sql_update_razon_social = "
					UPDATE tbl_conci_correo_metodo
					SET 
                        nombre = ?,
                        metodo = ?,
                        menu_id = ?,         
            ...
            $sql_insert_razon_social = "
                INSERT INTO tbl_conci_correo_metodo (
                    nombre,
                    metodo,
                    menu_id,
                    status,    
...
if (isset($_POST["accion"]) && $_POST["accion"] === "conci_mant_correo_eliminar") {
    $usuario_id = $login ? $login['id'] : null;
    $fecha = date("Y-m-d H:i:s");
    $result = array(); 
...
if (isset($_POST["accion"]) && $_POST["accion"] === "conci_mant_correo_guardar_integrante") {
    $usuario_id = $login ? $login['id'] : null;
    $fecha = date("Y-m-d H:i:s");
...
if (isset($_POST["accion"]) && $_POST["accion"] === "conci_mant_correo_eliminar_integrante") {
    $usuario_id = $login ? $login['id'] : null;
    $fecha = date("Y-m-d H:i:s");
