...
if (isset($_POST["accion"]) && $_POST["accion"] === "sec_soporte_alerta_betshop_retail_listar_locales") {
    try {
        $error = '';
        ...
        FROM
            ...
            WHERE lc.config_id = 'alerta_betshop_retail' and l.red_id in (1,16)
		";
...
if (isset($_POST["accion"]) && $_POST["accion"] === "sec_soporte_alerta_betshop_cambiar_estado") {
    try {
        $error = '';
        $mensaje = '';
        $id = (int)$_POST['id'];
