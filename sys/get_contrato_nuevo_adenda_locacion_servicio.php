...
d.nombre LOCADOR,
e.sigla,
concat('CÓDIGO: ',e.sigla,' ', a.codigo_correlativo,' - LOCATARIO: ',c.nombre, ' - LOCADOR: ',d.nombre) as nombre
...
INNER JOIN cont_correlativo e on e.tipo_contrato = a.tipo_contrato_id

WHERE a.tipo_contrato_id = 13
AND a.status = 1
AND a.etapa_id = 5
...
if (isset($_POST["accion"]) && $_POST["accion"] === "obtener_contrato_locacion_servicio_por_id") {
	...
	<div class="panel">
		<div class="panel-heading">
			<div class="panel-title">DETALLE DE LA SOLICITUD DE CONTRATO DE LOCACIÖN DE SERVICIO</div>
	...
	$html .= '<tr>';
	$html .= '<td style="width: 225px;"><b>Empresa Locador</b></td>';
	...
	while ($row = $propiertario_query->fetch_assoc()) {
		...
		$html .= '<span class="fa fa-pencil"></span> Reemplazar Locador';
		$html .= '</a>  ';
		...
		$html .= '<tr>';
		$html .= '<td style="width: 225px;"><b>Tipo de Persona</b></td>';
		$html .= '<td>' . $tipo_persona . '</td>';
		$html .= '<td style="width: 75px;">';
		$html .= '<a class="btn btn-success btn-xs" ';
		$html .= 'onclick="sec_con_nuevo_aden_arrend_solicitud_editar_campo_adenda(\'Locatario\',\'cont_persona\',\'tipo_persona_id\',\'Tipo de Persona\',\'select_option\',\'' . $tipo_persona . '\',\'obtener_tipo_persona\',\'\');">';
		$html .= '<span class="fa fa-edit"></span> Editar';
		$html .= '</a>';
		$html .= '</td>';
		$html .= '</tr>';
		...
		$html .= '<td style="width: 75px;">';
		$html .= '<a class="btn btn-success btn-xs" ';
		$html .= 'onclick="sec_con_nuevo_aden_arrend_solicitud_editar_campo_adenda(\'Locatario\',\'cont_persona\',\'nombre\',\'Nombre\',\'varchar\',\'' . $nombre . '\',\'\',\'\');">';
		$html .= '<span class="fa fa-edit"></span> Editar';
		$html .= '</a>';
		$html .= '</td>';
		$html .= '</tr>';
		...
		$html .= '<td style="width: 75px;">';
		$html .= '<a class="btn btn-success btn-xs" ';
		$html .= 'onclick="sec_con_nuevo_aden_arrend_solicitud_editar_campo_adenda(\'Locatario\',\'cont_persona\',\'tipo_docu_identidad_id\',\'Tipo de Documento de Identidad\',\'select_option\',\'' . $tipo_docu_identidad . '\',\'obtener_tipo_docu_identidad\',\'\');">';
		$html .= '<span class="fa fa-edit"></span> Editar';
		$html .= '</a>';
		$html .= '</td>';
		$html .= '</tr>';
		...
		$html .= '<td style="width: 75px;">';
		$html .= '<a class="btn btn-success btn-xs" ';
		$html .= 'onclick="sec_con_nuevo_aden_arrend_solicitud_editar_campo_adenda(\'Locatario\',\'cont_persona\',\'num_docu\',\'Número de Documento de Identidad\',\'varchar\',\'' . $num_docu . '\',\'\',\'\');">';
		$html .= '<span class="fa fa-edit"></span> Editar';
		$html .= '</a>';
		$html .= '</td>';
		$html .= '</tr>';
		...
		$html .= '<td style="width: 75px;">';
		$html .= '<a class="btn btn-success btn-xs" ';
		$html .= 'onclick="sec_con_nuevo_aden_arrend_solicitud_editar_campo_adenda(\'Locatario\',\'cont_persona\',\'num_ruc\',\'RUC\',\'varchar\',\'' . $num_ruc . '\',\'\',\'\');">';
		$html .= '<span class="fa fa-edit"></span> Editar';
		$html .= '</a>';
		$html .= '</td>';
		$html .= '</tr>';
		...
		$html .= '<tr>';
		$html .= '<td><b>Domicilio del Locatario</b></td>';
		$html .= '<td>' . $direccion . '</td>';
		$html .= '<td style="width: 75px;">';
		$html .= '<a class="btn btn-success btn-xs" ';
		$html .= 'onclick="sec_con_nuevo_aden_arrend_solicitud_editar_campo_adenda(\'Locatario\',\'cont_persona\',\'direccion\',\'Domicilio del Locatario\',\'varchar\',\'' . $direccion . '\',\'\',\'\');">';
		$html .= '<span class="fa fa-edit"></span> Editar';
		$html .= '</a>';
		$html .= '</td>';
		$html .= '</tr>';
		...
		$html .= '<td style="width: 75px;">';
		$html .= '<a class="btn btn-success btn-xs" ';
		$html .= 'onclick="sec_con_nuevo_aden_arrend_solicitud_editar_campo_adenda(\'Locatario\',\'cont_persona\',\'representante_legal\',\'Representante Legal\',\'varchar\',\'' . $representante_legal . '\',\'\',\'\');">';
		$html .= '<span class="fa fa-edit"></span> Editar';
		$html .= '</a>';
		$html .= '</td>';
		$html .= '</tr>';
		...
		$html .= '<td style="width: 75px;">';
		$html .= '<a class="btn btn-success btn-xs" ';
		$html .= 'onclick="sec_con_nuevo_aden_arrend_solicitud_editar_campo_adenda(\'Locatario\',\'cont_persona\',\'num_partida_registral\',\'N° de Partida Registral de la empresa\',\'varchar\',\'' . $num_partida_registral_per . '\',\'\',\'\');">';
		$html .= '<span class="fa fa-edit"></span> Editar';
		$html .= '</a>';
		$html .= '</td>';
		$html .= '</tr>';
	...
	// INICIO - Para locacion de servicio - detalle del contrato
	...
	WHERE cc.contrato_id = " . $id_contrato_arrendamiento;
		...
		$html .= '<div class="col-xs-12 col-md-12 col-lg-12">';
		$html .= '<div class="h4"><b>ANTECEDENTES</b></div>';
		$html .= '</div>';
		...
		$html .= '<tr>';
		$html .= '<td style="width: 225px;"><b>Locatario es una</b></td>';
		$html .= '<td>' . $locatario_descripcion . '</td>';
		$html .= '<td style="width: 75px;">';
		$html .= '<a class="btn btn-success btn-xs" ';
		$html .= 'onclick="sec_con_nuevo_aden_arrend_solicitud_editar_campo_adenda(\'Antecedentes\',\'cont_locacion\',\'locatario_descripcion\',\'Locatario es una\',\'varchar\',\'' . $locatario_descripcion . '\',\'obtener_tipo_moneda\',\'' . $idlocacion . '\');">';
		$html .= '<span class="fa fa-edit"></span> Editar';
		$html .= '</a>';
		$html .= '</td>';
		$html .= '</tr>';
		...
		$html .= '<tr>';
		$html .= '<td><b>Locador es una</b></td>';
		$html .= '<td>' . $locador_descripcion . '</td>';
		$html .= '<td style="width: 75px;">';
		$html .= '<a class="btn btn-success btn-xs" ';
		$html .= 'onclick="sec_con_nuevo_aden_arrend_solicitud_editar_campo_adenda(\'Antecedentes\',\'cont_locacion\',\'locador_descripcion\',\'Locador es una\',\'varchar\',\'' . $locador_descripcion . '\',\'obtener_tipo_moneda\',\'' . $idlocacion . '\');">';
		$html .= '<span class="fa fa-edit"></span> Editar';
		$html .= '</a>';
		$html .= '</td>';
		$html .= '</tr>';
		...
		$html .= '<tr>';
		$html .= '<td><b>Nombre del servicio</b></td>';
		$html .= '<td>' . $nombreservicio . '</td>';
		$html .= '<td style="width: 75px;">';
		$html .= '<a class="btn btn-success btn-xs" ';
		$html .= 'onclick="sec_con_nuevo_aden_arrend_solicitud_editar_campo_adenda(\'Antecedentes\',\'cont_locacion\',\'nombreservicio\',\'Nombre del servicio\',\'varchar\',\'' . $nombreservicio . '\',\'obtener_tipo_moneda\',\'' . $idlocacion . '\');">';
		$html .= '<span class="fa fa-edit"></span> Editar';
		$html .= '</a>';
		$html .= '</td>';
		$html .= '</tr>';
		...
		$html .= '<div class="col-xs-12 col-md-12 col-lg-12">';
		$html .= '<div class="h4"><b>OBJETIVO</b></div>';
		$html .= '</div>';
		...
		$html .= '<tr>';
		$html .= '<td style="width: 225px;"><b>Funciones del Locatario</b></td>';
		$html .= '<td>' . $locatario_descripcion . '</td>';
		$html .= '<td style="width: 75px;">';
		$html .= '<a class="btn btn-success btn-xs" ';
		$html .= 'onclick="sec_con_nuevo_aden_arrend_solicitud_editar_campo_adenda(\'Objetivo\',\'cont_locacion\',\'locador_funciones\',\'Funciones del Locatario\',\'varchar\',\'' . $locatario_descripcion . '\',\'\',\'' . $idlocacion . '\');">';
		$html .= '<span class="fa fa-edit"></span> Editar';
		$html .= '</a>';
		$html .= '</td>';
		$html .= '</tr>';
		...
		$html .= '<td style="width: 75px;">';
		$html .= '<a class="btn btn-success btn-xs" ';
		$html .= 'onclick="sec_con_nuevo_aden_arrend_solicitud_editar_campo_adenda(\'Antecedentes\',\'cont_locacion\',\'locador_descripcion\',\'Locador es una\',\'varchar\',\'' . $locador_descripcion . '\',\'\',\'' . $idlocacion . '\');">';
		$html .= '<span class="fa fa-edit"></span> Editar';
		$html .= '</a>';
		$html .= '</td>';
		$html .= '</tr>';
		...
		$html .= '<td style="width: 75px;">';
		$html .= '<a class="btn btn-success btn-xs" ';
		$html .= 'onclick="sec_con_nuevo_aden_arrend_solicitud_editar_campo_adenda(\'Antecedentes\',\'cont_locacion\',\'nombreservicio\',\'Nombre del servicio\',\'varchar\',\'' . $nombreservicio . '\',\'\',\'' . $idlocacion . '\');">';
		$html .= '<span class="fa fa-edit"></span> Editar';
		$html .= '</a>';
		$html .= '</td>';
		$html .= '</tr>';
		...
		$html .= '<div class="col-xs-12 col-md-12 col-lg-12">';
		$html .= '<div class="h4"><b>PLAZO DEL CONTRATO</b></div>';
		$html .= '</div>';
		...
		$html .= '<tr>';
		$html .= '<td style="width: 225px;"><b>Contrato - Fecha de Inicio</b></td>';
		$html .= '<td>' . $contrato_inicio_fecha . '</td>';
		$html .= '<td style="width: 75px;">';
		$html .= '<a class="btn btn-success btn-xs" ';
		$html .= 'onclick="sec_con_nuevo_aden_arrend_solicitud_editar_campo_adenda(\'Plazo del contrato\',\'cont_locacion\',\'fecha_inicio\',\'Contrato - Fecha de Inicio\',\'date\',\'' . $contrato_inicio_fecha . '\',\'\',\'' . $idlocacion . '\');">';
		$html .= '<span class="fa fa-edit"></span> Editar';
		$html .= '</a>';
		$html .= '</td>';
		$html .= '</tr>';
		...
		$html .= '<td style="width: 75px;">';
		$html .= '<a class="btn btn-success btn-xs" ';
		$html .= 'onclick="sec_con_nuevo_aden_arrend_solicitud_editar_campo_adenda(\'Plazo del contrato\',\'cont_locacion\',\'fecha_fin\',\'Contrato - Fecha de Fin\',\'date\',\'' . $contrato_fin_fecha . '\',\'\',\'' . $idlocacion . '\');">';
		$html .= '<span class="fa fa-edit"></span> Editar';
		$html .= '</a>';
		$html .= '</td>';
		$html .= '</tr>';
		...
		$html .= '<div class="col-xs-12 col-md-12 col-lg-12">';
		$html .= '<div class="h4"><b>CONTRAPRESTACIÓN</b></div>';
		$html .= '</div>';
		...
		$html .= '<tr>';
		$html .= '<td style="width: 225px;"><b>Monto del Contrato</b></td>';
		$html .= '<td>' . $monto . '</td>';
		$html .= '<td style="width: 75px;">';
		$html .= '<a class="btn btn-success btn-xs" ';
		$html .= 'onclick="sec_con_nuevo_aden_arrend_solicitud_editar_campo_adenda(\'Contraprestación\',\'cont_contraprestacion\',\'monto\',\'Monto del Contrato\',\'varchar\',\'' . $monto . '\',\'\',\'' . $idlocacion . '\');">';
		$html .= '<span class="fa fa-edit"></span> Editar';
		$html .= '</a>';
		$html .= '</td>';
		$html .= '</tr>';
		...
		$html .= '<td style="width: 75px;">';
		$html .= '<a class="btn btn-success btn-xs" ';
		$html .= 'onclick="sec_con_nuevo_aden_arrend_solicitud_editar_campo_adenda(\'Fecha de suscripción\',\'cont_locacion\',\'fecha_suscripcion_contrato\',\'Fecha de suscripción del contrato\',\'date\',\'' . $contrato_fecha_suscripcion . '\',\'\',\'' . $idlocacion . '\');">';
		$html .= '<span class="fa fa-edit"></span> Editar';
		$html .= '</a>';
		$html .= '</td>';
		$html .= '</tr>';
	...
	// FIN - Para locacion de servicio - detalle del contrato
