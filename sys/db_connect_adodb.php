 ...
 */
require_once('/var/www/html/vendor/adodb5/adodb.inc.php');
require_once('/var/www/html/vendor/adodb5/adodb-active-record.inc.php');
require_once('/var/www/html/vendor/adodb5/adodb-exceptions.inc.php');
$ADODB_FETCH_MODE = ADODB_FETCH_ASSOC;
$ADODB_FORCE_VALUE = ADODB_FORCE_IGNORE;
$_adodb_host=env('DB_HOST');
$_adodb_user=env('DB_USERNAME');
$_adodb_pass=env('DB_PASSWORD');
$_adodb_database= env('DB_DATABASE');
$_adodb_port='3306';
