...
if (isset($_POST["accion"]) && $_POST["accion"] === "conci_reporte_recaudacion_Datatable") {
    ...
    $column_titles = [
        "comision_calimaco" => "Monto a Recaudar",
        "monto_recaudado" => "Monto Recaudado",
        "CASE WHEN (comision_calimaco - monto_recaudado) > 0 THEN (comision_calimaco - monto_recaudado) ELSE 0 END" => "Faltante",
        "CASE WHEN (monto_recaudado - comision_calimaco) > 0 THEN (monto_recaudado - comision_calimaco) ELSE 0 END" => "Sobrante"
    ];
...
if (isset($_POST["accion"]) && $_POST["accion"] === "conci_reporte_recaudacion_proveedor_listar") {
    try {
