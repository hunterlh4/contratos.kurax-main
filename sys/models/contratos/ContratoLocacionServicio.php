<?php
class ContratoLocacionServicio extends Model
{
    ...
    public function registrar_locacion($data)
    {
        $query = '';
        try {
            $query = "INSERT INTO cont_locacion (
                        idcontratodetalle,
                        idcontrato,
                        nombreservicio,
                        fechainicio,
                        ...
                        " . (isset($data['idcontratodetalle']) ? $data["idcontratodetalle"] : "NULL") . ",
                        " . (isset($data['idcontrato']) ? $data["idcontrato"] : "NULL") . ",
                        '" . (isset($data["nombreservicio"]) ? $data["nombreservicio"] : "") . "',
                        '" . (isset($data["fechainicio"]) ? $data["fechainicio"] : "NULL") . "',
                        '" . (isset($data["fechafin"]) ? $data["fechafin"] : "NULL") . "',
                        '" . (isset($data["locador_descripcion"]) ? $data["locador_descripcion"] : "") . "',
                        '" . (isset($data["locatario_descripcion"]) ? $data["locatario_descripcion"] : "") . "',
                        '" . (isset($data["locador_funciones"]) ? $data["locador_funciones"] : "") . "'
                    )";
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////
    public function obtener_solicitud_contrato_locacion_detallado($contrato_id) {
        try {
            ...
            // Obtener datos de la locación
            $query_locacion = "SELECT 
                                    cl.nombreservicio,
                                    cl.fechainicio,
                                    cl.fechafin,
                                ...
                                WHERE cl.idcontrato = :contrato_id";
            $stmt_locacion = $this->db->prepare($query_locacion);
            $stmt_locacion->execute(['contrato_id' => $contrato_id]);
            $data_locacion = $stmt_locacion->fetchAll(PDO::FETCH_ASSOC);
    
            // Construir el array de respuesta
            $contratos = [
                'datos_generales' => $datos_generales,
                'data_locacion' => $data_locacion
            ];
