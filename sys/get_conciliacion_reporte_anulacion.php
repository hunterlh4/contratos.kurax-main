...
if (isset($_POST["accion"]) && $_POST["accion"] === "conci_reporte_anulacion_Datatable") {
    ...
    $column_titles = [
        ...
        "comision_anulada" => "Comisión Anulada",
        "anulados_count" => "Conteo Anulados"
    ];
...
if (isset($_POST["accion"]) && $_POST["accion"] === "conci_reporte_anulacion_proveedor_listar") {
    try {
