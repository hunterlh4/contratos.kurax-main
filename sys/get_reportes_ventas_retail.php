...
if (isset($_POST["accion"]) && $_POST["accion"]==="listar_transacciones_resumen_v2") {
	...
	$query_COUNT ="
		SELECT
			...
			IFNULL(SUM(IF(tra.tipo_id=34, 1, 0)), 0) AS num_apuesta_cancelada,
			IFNULL(SUM(IF(tra.tipo_id=34, tra.monto, 0)), 0) AS total_apuesta_cancelada,
...
if (isset($_POST["accion"]) && $_POST["accion"]==="listar_transacciones_export_xls") {
	...
	if ($mysqli->error) {
		...
		$date = new DateTime();
		$file_title = "reporte_ventas_retail" . $date->getTimestamp();
