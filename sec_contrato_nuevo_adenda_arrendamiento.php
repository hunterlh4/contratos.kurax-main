	...
	<div id="div_sec_contrato_nuevo">
		...
		<div class="row">
			<div class="col-xs-12 text-center">
				<h1 class="page-title titulosec_contrato"><i class="icon icon-inline glyphicon glyphicon-briefcase"></i> Nueva Solicitud - Adenda de Contrato de Arrendamiento</h1>
			</div>
		</div>
							...
							<div class="row">
								<div class="col-xs-12 col-md-12 col-lg-12">
									<div class="form-group">
										...
										<select onchange="sec_con_nuevo_aden_arrend_obtener_contratos_interno_id()" class="form-control input_text select2" name="sec_con_nuevo_tienda" id="sec_con_nuevo_tienda">
										</select>
									</div>
								</div>
