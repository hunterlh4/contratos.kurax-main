...
<div id="div_sec_contrato_nuevo">
	...
	<div class="row">
		<div class="col-xs-12 text-center">
			<h1 class="page-title titulosec_contrato"><i class="icon icon-inline glyphicon glyphicon-briefcase"></i> Nueva Solicitud - Adenda Acuerdo de Confidencialidad</h1>
		</div>
	</div>
						...
						<div class="row">
							<div class="col-xs-12 col-md-6 col-lg-6">
								<div class="form-group">
									<label for="sec_con_nuevo_empresa_grupo_at_1">Nombre del Proveedor :</label>
									<select onchange="sec_con_nuevo_aden_acu_conf_obtener_contratos()" class="form-control input_text select2" name="sec_con_nuevo_proveedor_cont" id="sec_con_nuevo_proveedor_cont" 
							...
							<div class="col-xs-12 col-md-6 col-lg-6">
								<div class="form-group">
									...
									<select onchange="sec_con_nuevo_aden_acu_conf_obtener_contratos_interno_id()" class="form-control select2" name="sec_con_nuevo_contrato_id" id="sec_con_nuevo_contrato_id">
									</select>
								</div>
							</div>
						</div>
												...
												<div id="browsers-this-week" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="browsers-this-week-heading">
													<div class="panel-body">
														...
														<div class="form-group" style="margin-bottom: 10px; margin-top: 10px;" >
															...
															<br>
														<button type="button" class="btn btn-success btn-xs btn-block" id="btnRegistrarAdenda" onclick="sec_con_nuevo_aden_acu_conf_guardar_adenda();">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-success" id="btnModalRegistrarAdenda" onclick="sec_con_nuevo_aden_acu_conf_guardar_detalle_adenda('modalAgregar');">
...
<div id="modalNuevoProveedor" class="modal fade" role="dialog" aria-labelledby="myLargeModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="modal_nuevo_proveedor_titulo_ap">Adenda - Representante Legal</h4>
			</div>
			<div class="modal-body">
				<div class="row">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar Ventana</button>
				<button type="button" onclick="sec_con_nuevo_aden_acu_conf_guardar_nuevo_representante_legal()" class="btn btn-success" >
					<i class="icon fa fa-plus"></i>
...
<div id="modalNuevoContraprestacion" class="modal fade" role="dialog" aria-labelledby="myLargeModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar Ventana</button>
				<button type="button" class="btn btn-success" onclick="sec_con_nuevo_aden_acu_conf_nuevo_contraprestacion()" id="btn_agregar_contraprestacion_ap">
					<i class="icon fa fa-plus"></i>
