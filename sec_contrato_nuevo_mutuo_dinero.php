...
?>
    ...
    <div id="div_sec_contrato_nuevo_arrendamiento">
      ...
      <div class="row">
        <div class="col-xs-12 text-center">
          <h1 class="page-title titulosec_contrato"><i class="icon icon-inline glyphicon glyphicon-briefcase"></i> Nueva Solicitud - Mutuo de Dinero</h1>
        </div>
      </div>
            ...
            <div class="row">
              ...
              <div class="col-xs-12 col-md-12 col-lg-12">
                <button v-if="btn_registrar" type="button" class="btn btn-success btn-block" @click="validar_contrato">
                  ...
                  <span id="demo-button-text"> Enviar Solicitud de Mutuo de Dinero</h1>
              </div></span>
              </button>
            </div>
  ...
  <!-- Components -->
  <script src="./vue/contrato-mutuodinero/components/component-contrato_mutuodinero.js"></script>
  <script src="./vue/contrato-mutuodinero/components/loader.js"></script>
  <script src="./vue/contrato-mutuodinero/components/component-modal-propietario-buscar.js"></script>
  <script src="./vue/contrato-mutuodinero/components/component-propietario-lista.js"></script>
  <script src="./vue/contrato-mutuodinero/components/component-modal-propietario-registro.js"></script>

  <script src="./vue/contrato-mutuodinero/components/component-modal-anexo.js"></script>
  <script src="./vue/contrato-mutuodinero/components/component-modal-anexo-registro.js"></script>
  <script src="./vue/contrato-mutuodinero/components/component-modal-responsables-ir.js"></script>
  <script src="./vue/contrato-mutuodinero/components/component-modal-responsable-ir-registro.js"></script>
  <!-- Store -->

  <script src="./vue/contrato-mutuodinero/vuex/modules/vuex-contrato.js"></script>
  <script src="./vue/contrato-mutuodinero/vuex/index.js"></script>
  <!-- Main JS -->
  <script src="./vue/contrato-mutuodinero/main-nuevo_mutuo_dinero.js"></script>
