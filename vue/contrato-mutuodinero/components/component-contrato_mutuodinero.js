const contrato = {
  template: `
    <section> 
            <div class="panel-body mt-5">
                <div class="panel">
                    <div class="panel-heading">Descripción de Actividades</div>
                    <div class="panel-body">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label for="mutuante_descripcion">Mutuante:</label>
                                <textarea class="form-control resize" v-model="contrato.mutuante_descripcion" rows="2" type="text"></textarea>
                            </div>
                        </div> 
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label for="mutuatario_descripcion">Mutuatario:</label>
                                <textarea class="form-control resize" v-model="contrato.mutuatario_descripcion" rows="2" type="text"></textarea>
                            </div>
                        </div> 
                    </div>
                    <div class="panel-heading">Importe dinerario</div>
                    <div class="panel-body">
                        <div class="col-md-4 col-sm-12">
                        <div class="form-group">
                            <label for="">Moneda del Contrato:</label>
                            <v-select  placeholder="-- Seleccione --" class="w-100" :options="monedas" :filterable="true" label="text"  v-model='moneda_val'></v-select>
                        </div>
                        </div>
                        <div class="col-md-8 col-sm-12">
                            <div class="form-group">
                                <label for="monto">Monto:</label>
                                <input class="form-control" v-model="contrato.monto" type="number">
                            </div>
                        </div> 
                    ...
                    <div class="panel-heading">Tasa de Interés y Plazo para la Devolución</div>
                    <div class="panel-body">
                   <!--  <div class="form-group">
                                <label for="tasa_interes">Tasa Interés:</label>
                                <input class="form-control" v-model="contrato.tasa_interes" type="number" disabled readonly>
                            </div>
                        </div>--->
                         <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label for="fecha_plazo_limite">Fecha del plazo límite:</label>
                                <input class="form-control" v-model="contrato.fecha_plazo_limite" type="date">
                            </div>
                        </div>
                    </div>
                    <div class="panel-heading">Lugar y fecha de subscripción del contrato</div>
                    <div class="panel-body">
                       <div class="col-md-6">
                            <div class="form-group">
                                <label for="ciudad">Ciudad:</label>
                                <input class="form-control" v-model="contrato.ciudad" type="text">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="fecha_subscripcion">Fecha:</label>
                                <input class="form-control" v-model="contrato.fecha_subscripcion" type="date">
                            </div>
                        </div>
                    </div> 
                </div>
  ...
  watch: {
    ...
    moneda_val(newValue) {
      if (newValue == null) {
        this.contrato.tipo_moneda_id = "";
        return false;
      }
      this.contrato.tipo_moneda_id = newValue.id;
    },
...
Vue.component("component-contrato_locacion", contrato);
...
function calcular_monto_segun_impuesto() {
  ...
  let data = {
    ...
    tipo_moneda_id: this.contrato.tipo_moneda_id,
