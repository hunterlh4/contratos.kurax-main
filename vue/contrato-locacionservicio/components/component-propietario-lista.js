  ...
  template: `
    <div class="table-responsive">
        ...
        <table class="table table-bordered table-hover no-mb">
            <thead>
                <tr>
                    <th colspan="5" class="text-center">DATOS DEL LOCATARIO</th>
            ...
            <tbody>
                <tr v-for="(item, it) in propietarios" :key="it">
                    ...
                    <td class="text-center">
                        <a class="btn btn-warning btn-xs" data-toggle="tooltip" data-placement="top" title="Editar"   @click="editar_propietario(it)"><i class="fa fa-edit"></i></a>
                        <a class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="top" title="Eliminar del contrato"  @click="eliminar_propietario(it)"><i class="fa fa-trash"></i></a>
                    </td>
                </tr>
            </tbody>
        </table>
