                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label for="locatario_descripcion">Locatario es una:</label>
                                <input class="form-control" v-model="contrato.locatario_descripcion" type="text">
                            </div>
                        </div> 
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label for="locador_descripción">Locador es una:</label>
                                <input class="form-control" v-model="contrato.locador_descripción" type="text">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="locador_nombre_servicio">Nombre del servicio:</label>
                                <textarea class="form-control" v-model="contrato.locador_nombre_servicio" rows="2" type="text"></textarea>
                            </div>
                        </div> 
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                <label for="locador_funciones">Funciones del Locatario:</label>
                                <textarea class="form-control" v-model="contrato.locador_funciones" rows="4" type="text"></textarea>
                            </div>
                        </div> 
                    </div>
                    <div class="panel-heading">Plazo del contrato</div>
                    <div class="panel-body"> 
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="fecha_inicio">Fecha de Inicio:</label>
                                <input class="form-control" v-model="contrato.fecha_inicio" type="date">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="fecha_fin">Fecha de Fin:</label>
                                <input class="form-control" v-model="contrato.fecha_fin" type="date">
                            </div>
                        </div> 
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                          <div class="panel-heading">Contraprestación</div>
                    <div class="panel-body">
                        ...
                        <div class="col-md-6">
                            <div class="panel-heading">Fecha subscripción del contrato</div>
                    <div class="panel-body">
