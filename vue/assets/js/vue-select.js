  ...
  return (() => {
    ...
    return (
      (() => {
        "use strict";
        n.r(o),
          n.d(o, { VueSelect: () => m, default: () => O, mixins: () => _ });
        var e = n(319),
          t = n.n(e),
          i = n(8),
          s = n.n(i),
        ...
        const m = p(
            {
              ...
              props: {
                ...
                createOption: {
                  type: Function,
                  default: function (e) {
                    return "object" === s()(this.optionList[0])
                      ? a()({}, this.label, e)
                      : e;
                  },
                },
              ...
              watch: {
                options: function (e, t) {
                  var n = this;
                  !this.taggable &&
                    ("function" == typeof n.resetOnOptionsChange
                      ? n.resetOnOptionsChange(e, t, n.selectedValue)
                      : n.resetOnOptionsChange) &&
                    this.clearSelection(),
                    this.value &&
                ...
                findOptionFromReducedValue: function (e) {
                  var n = this,
                    o = []
                      ...
                      .filter(function (t) {
                        return (
                          JSON.stringify(n.reduce(t)) === JSON.stringify(e)
                        );
                      });
                  return 1 === o.length
                    ? o[0]
            ...
            function () {
              ...
              return n(
                ...
                [
                  ...
                  e._v(" "),
                  n("transition", { attrs: { name: e.transition } }, [
                    e.dropdownOpen
                      ? n(
                          "ul",
                          {
                          ...
                          [
                            e._t("list-header", null, null, e.scope.listHeader),
                            e._v(" "),
                            e._l(e.filteredOptions, function (t, o) {
                              return n(
                                "li",
                                {
                                  key: e.getOptionKey(t),
                                  ...
                                  attrs: {
                                    ...
                                    role: "option",
                                    "aria-selected":
                                      o === e.typeAheadPointer || null,
                                  },
                                  on: {
                                    mouseover: function (n) {
                                      e.selectable(t) &&
                                        (e.typeAheadPointer = o);
                                    },
                                    click: function (n) {
                                      n.preventDefault(),
                                        n.stopPropagation(),
                            ...
                            0 === e.filteredOptions.length
                              ...
                              : e._e(),
                            e._v(" "),
                            e._t("list-footer", null, null, e.scope.listFooter),
                          ],
                          2
                        )
                      : n("ul", {
