                    ...
                    <div class="panel-body">
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                <label for="locatario_descripcion">La mandante es:</label>
                                <input class="form-control" v-model="contrato.mandante_antecedente" type="text">
                            </div>
                        </div> 
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                <label for="locador_descripción">La mandataria se obliga a:</label>
                                <input class="form-control" v-model="contrato.mandataria_objetivo" type="text">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="locador_nombre_servicio">La mandataria será el:</label>
                                <textarea class="form-control" v-model="contrato.mandataria_retribucion" rows="2" type="text"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="locador_nombre_servicio">Plazo de duración (meses):</label>
                                <input class="form-control" v-model="contrato.plazo_duracion" type="number">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" v-model="contrato.fecha_suscripcion" type="date">
                            </div>
                        </div>
                    </div>
                        </div>           
