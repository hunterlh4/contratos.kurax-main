        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="modal_buscar_propietario_titulo">Buscar Mandante</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-control-lg2" v-model="propietario.tipo_busqueda">
                                <option value="1">Buscar por nombre de Mandante</option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <button type="button" @click="BuscarPropietarios" class="btn btn-info">
                                    <i class="icon fa fa-search"></i><span> Buscar Mandante</span>
                                </button>
                            </div>
                        </div>
                                        ...
                                        <tr v-for="(item, it) in resultados" :key="it">
                                            ...
                                            <td class="text-center">
                                                <button class="btn btn-success btn-xs" type="button" @click="AgregarPropietario(it)">
                                                    <i class="fa fa-plus"></i> Agregar como Mandante
                                                </button>
                                            </td>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="col-md-12 text-center">
                        <button type="button" @click="ShowModalRegistroPropietario" class="btn btn-success btn-sm">
                            ...
                            <span id="demo-button-text"> Registrar Nuevo Mandante</span>
                        </button>
                    </div>
...
function AgregarPropietario(index) {
  ...
  if (existe == -1) {
    ...
    alertify.success("Se ha agregado el mandante", 5);
