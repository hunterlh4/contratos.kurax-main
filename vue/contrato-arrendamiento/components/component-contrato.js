...
const contrato = {
    ...
    watch:{
        ...
        distrito_val (newValue){
            ...
            this.contrato.inmuebles.ubigeo_id = this.contrato.inmuebles.departamento_id + this.contrato.inmuebles.provincia_id + this.contrato.inmuebles.distrito_id
        ...
        compromiso_pago_agua_val(newValue){
            ...
            if (this.contrato.inmuebles.tipo_compromiso_pago_agua == 1 || this.contrato.inmuebles.tipo_compromiso_pago_agua == 2 || this.contrato.inmuebles.tipo_compromiso_pago_agua == 6 || this.contrato.inmuebles.tipo_compromiso_pago_agua == 7) {
        ...
        compromiso_pago_luz_val(newValue){
            ...
            if (this.contrato.inmuebles.tipo_compromiso_pago_luz == 1 || this.contrato.inmuebles.tipo_compromiso_pago_luz == 2 || this.contrato.inmuebles.tipo_compromiso_pago_luz == 6 || this.contrato.inmuebles.tipo_compromiso_pago_luz == 7) {
...
function show_modal_modificar_adelantos() {
    ...
    $('#component_modal_adelantos_'+this.index).modal({ backdrop: "static", keyboard: false });
...
function calcular_monto_segun_impuesto(){
    ...
    if (data.tipo_moneda_id.length == 0 
...
function show_modal_nuevo_incremento() {
    ...
    $('#component_modal_incrementos_' + this.index).modal({ backdrop: "static", keyboard: false });
...
function show_modal_nueva_inflacion() {
    ...
    $('#component_modal_inflaciones_' + this.index).modal({ backdrop: "static", keyboard: false });
...
function show_modal_nueva_cuota_extraordinaria() {
    ...
    $('#component_modal_cuotas_extraordinarias_' + this.index).modal({ backdrop: "static", keyboard: false });
...
function show_modal_nuevo_beneficiario() {
    ...
    $('#component_modal_beneficiarios_'+this.index).modal({ backdrop: "static", keyboard: false });
...
function show_modal_nuevo_responsable_ir() {
    ...
    $('#component_modal_responsables_ir_' + this.index).modal({ backdrop: "static", keyboard: false });
