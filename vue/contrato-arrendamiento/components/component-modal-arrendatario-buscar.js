// BUSCAR ARRENDATARIO 1B
Vue.component("component-modal-arrendatario-buscar", {
  template: `
    <div id="component-modal-buscar-arredantario" class="modal" data-keyboard="false">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="modal_buscar_propietario_titulo">Buscar Arrendatario</h4>
                </div>
                <div class="modal-body">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <select class="form-control-lg2" v-model="propietario.tipo_busqueda">
                                    <option value="1">Buscar por nombre de Arrendatario</option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <button type="button" @click="BuscarPropietarios" class="btn btn-info">
                                    <i class="icon fa fa-search"></i><span> Buscar Arrendatario</span>
                                </button>
                            </div>
                        </div>
                                        ...
                                        <tr v-for="(item, it) in resultados" :key="it">
                                            ...
                                            <td class="text-center">
                                                <button class="btn btn-success btn-xs" type="button" @click="AgregarPropietario(it)">
                                                    <i class="fa fa-plus"></i> Agregar como Arrendatario
                                                </button>
                                            </td>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="col-md-12 text-center">
                        <button type="button" @click="ShowModalRegistroPropietario" class="btn btn-success btn-sm">
                            ...
                            <span id="demo-button-text"> Registrar Nuevo Arrendatario</span>
                        </button>
                    </div>
  ...
  mounted() {
    EventBus.$on("modal-registro-arrendatario-buscar", () => {
      setTimeout(() => {
...
function AgregarPropietario(index) {
  ...
  const existe = this.arrendatarios
    .map((item) => item.id)
    .indexOf(propietario.id);
  console.log(existe);
  if (existe == -1) {
    this.arrendatarios.push(propietario);
    alertify.success("Se ha agregado al arrendatario", 5);
    $("#component-modal-buscar-arredantario").modal("hide");
  }
}
...
function ShowModalRegistroPropietario() {
  ...
  EventBus.$emit("modal-registro-arrendatario", data);
