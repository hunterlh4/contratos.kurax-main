  ...
  template: `
    <div class="table-responsive">
        ...
        <table class="table table-bordered table-hover no-mb">
            <thead>
                <tr>
                    <th colspan="5" class="text-center">DATOS DEL ARRENDADOR</th>
    ...
    <div style="display: flex; justify-content: center; gap: 5px;">
        <a class="btn btn-warning btn" data-toggle="tooltip" data-placement="top" title="Editar" @click="editar_propietario(it)">
            <i class="fa fa-edit"></i>
        </a>
        <a class="btn btn-danger btn" data-toggle="tooltip" data-placement="top" title="Eliminar del contrato" @click="eliminar_propietario(it)">
...
function editar_propietario(index) {
  ...
  console.log("editar propietario");
