...
global $mysqli;
$menu_id = "";
$result = $mysqli->query("SELECT id FROM tbl_menu_sistemas WHERE sec_id = 'contrato' AND sub_sec_id = 'proveedor' LIMIT 1");
	...
	<div class="page-header wide">
		<div class="row">
			<div class="col-xs-12 text-center">
				<h1 class="page-title titulosec_contrato"><i class="icon icon-inline glyphicon glyphicon-briefcase"></i> 	Contratos Proveedores firmados</h1>
			</div>
		</div>
	</div>
			...
			<fieldset class="dhhBorder">
				...
				<form autocomplete="off">
					<div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12">
						...
						<div class="form-group">
							<div class="input-group col-xs-12">
								<select
									class="form-control input_text select2 change-contrato-proveedor-firmado"
					...
					<div class="form-search-aprobante col-lg-3 col-md-3 col-sm-3 col-xs-12" style="height: 55px;">
						...
						<div class="form-group">
							<div class="input-group col-xs-12">
								<select class="form-control select2 change-contrato-proveedor-firmado" name="director_aprobacion_id" id="director_aprobacion_id" title="Seleccione a el director">
								</select>
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-right" style="margin-top: 15px; margin-bottom: 15px; float: right;">
						...
						<button type="button" class="btn btn-success float-left" id="cont_proveedor_btn_export_proveedor">
							<i class="fa fa-file-excel-o"></i>
							Exportar excel
						</button>
						<button type="button" class="btn btn-primary float-left" onclick="cont_proveedor_buscar_proveedor_por_parametros();">
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div>
					...
					<div class="col-md-2" style="padding-bottom: 5px;">
						<input type="text" class="form-control input-sm" name="num_dias" id="num_dias" maxlength="3" min="0" max="999" onkeypress="sec_contrato_proveedor_validar_solo_numeros(event)">
					</div>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-success" onclick="sec_contrato_proveedor_registrar_alerta();">
